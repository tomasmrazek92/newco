...
`)+`
`+u);let w=T+p+a,b=T+u+o,D=ec(s,s.VERTEX_SHADER,w),A=ec(s,s.FRAGMENT_SHADER,b);s.attachShader(y,D),s.attachShader(y,A),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function I(C){if(i.debug.checkShaderErrors){let q=s.getProgramInfoLog(y).trim(),z=s.getShaderInfoLog(D).trim(),W=s.getShaderInfoLog(A).trim(),K=!0,H=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,D,A);else{let tt=ic(s,D,"vertex"),V=ic(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`;function Ep(i,t,e){let n=new ji,s=new Wt,r=new Wt,a=new ne,o=new Ys({depthPacking:El}),l=new $s,c={},h=e.maxTextureSize,d={[fn]:Se,[Se]:fn,[Ve]:Ve},f=new De({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Wt},radius:{value:4}},vertexShader:bp,fragmentShader:wp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;let x=new je;x.setAttribute("position",new Pe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new Te(x,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Da;let u=this.type;this.render=function(A,I,U){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;let M=i.getRenderTarget(),v=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),q=i.state;q.setBlending(_n),q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);let z=u!==tn&&this.type===tn,W=u===tn&&this.type!==tn;for(let K=0,H=A.length;K<H;K++){let tt=A[K],V=tt.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",tt,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let rt=V.getFrameExtents();if(s.multiply(rt),r.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/rt.x),s.x=r.x*rt.x,V.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/rt.y),s.y=r.y*rt.y,V.mapSize.y=r.y)),V.map===null||z===!0||W===!0){let yt=this.type!==tn?{minFilter:Be,magFilter:Be}:{};V.map!==null&&V.map.dispose(),V.map=new Qe(s.x,s.y,yt),V.map.texture.name=tt.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();let ut=V.getViewportCount();for(let yt=0;yt<ut;yt++){let Ut=V.getViewport(yt);a.set(r.x*Ut.x,r.y*Ut.y,r.x*Ut.z,r.y*Ut.w),q.viewport(a),V.updateMatrices(tt,yt),n=V.getFrustum(),b(I,U,V.camera,tt,this.type)}V.isPointLightShadow!==!0&&this.type===tn&&T(V,U),V.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(M,v,C)};function T(A,I){let U=t.update(y);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Qe(s.x,s.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(I,null,U,f,y,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(I,null,U,m,y,null)}function w(A,I,U,M){let v=null,C=U.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(C!==void 0)v=C;else if(v=U.isPointLight===!0?l:o,i.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0){let q=v.uuid,z=I.uuid,W=c[q];W===void 0&&(W={},c[q]=W);let K=W[z];K===void 0&&(K=v.clone(),W[z]=K,I.addEventListener("dispose",D)),v=K}if(v.visible=I.visible,v.wireframe=I.wireframe,M===tn?v.side=I.shadowSide!==null?I.shadowSide:I.side:v.side=I.shadowSide!==null?I.shadowSide:d[I.side],v.alphaMap=I.alphaMap,v.alphaTest=I.alphaTest,v.map=I.map,v.clipShadows=I.clipShadows,v.clippingPlanes=I.clippingPlanes,v.clipIntersection=I.clipIntersection,v.displacementMap=I.displacementMap,v.displacementScale=I.displacementScale,v.displacementBias=I.displacementBias,v.wireframeLinewidth=I.wireframeLinewidth,v.linewidth=I.linewidth,U.isPointLight===!0&&v.isMeshDistanceMaterial===!0){let q=i.properties.get(v);q.light=U}return v}function b(A,I,U,M,v){if(A.visible===!1)return;if(A.layers.test(I.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&v===tn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,A.matrixWorld);let z=t.update(A),W=A.material;if(Array.isArray(W)){let K=z.groups;for(let H=0,tt=K.length;H<tt;H++){let V=K[H],rt=W[V.materialIndex];if(rt&&rt.visible){let ut=w(A,rt,M,v);A.onBeforeShadow(i,A,I,U,z,ut,V),i.renderBufferDirect(U,null,z,ut,A,V),A.onAfterShadow(i,A,I,U,z,ut,V)}}}else if(W.visible){let K=w(A,W,M,v);A.onBeforeShadow(i,A,I,U,z,K,null),i.renderBufferDirect(U,null,z,K,A,null),A.onAfterShadow(i,A,I,U,z,K,null)}}let q=A.children;for(let z=0,W=q.length;z<W;z++)b(q[z],I,U,M,v)}function D(A){A.target.removeEventListener("dispose",D);for(let U in c){let M=c[U],v=A.target.uuid;v in M&&(M[v].dispose(),delete M[v])}}}var Tp={[or]:lr,[cr]:dr,[hr]:fr,[Wn]:ur,[lr]:or,[dr]:cr,[fr]:hr,[ur]:Wn};function Ap(i,t){function e(){let R=!1,it=new ne,k=null,Z=new ne(0,0,0,0);return{setMask:function(ct){k!==ct&&!R&&(i.colorMask(ct,ct,ct,ct),k=ct)},setLocked:function(ct){R=ct},setClear:function(ct,lt,Pt,re,me){me===!0&&(ct*=re,lt*=re,Pt*=re),it.set(ct,lt,Pt,re),Z.equals(it)===!1&&(i.clearColor(ct,lt,Pt,re),Z.copy(it))},reset:function(){R=!1,k=null,Z.set(-1,0,0,0)}}}function n(){let R=!1,it=!1,k=null,Z=null,ct=null;return{setReversed:function(lt){if(it!==lt){let Pt=t.get("EXT_clip_control");it?Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.ZERO_TO_ONE_EXT):Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.NEGATIVE_ONE_TO_ONE_EXT);let re=ct;ct=null,this.setClear(re)}it=lt},getReversed:function(){return it},setTest:function(lt){lt?at(i.DEPTH_TEST):Et(i.DEPTH_TEST)},setMask:function(lt){k!==lt&&!R&&(i.depthMask(lt),k=lt)},setFunc:function(lt){if(it&&(lt=Tp[lt]),Z!==lt){switch(lt){case or:i.depthFunc(i.NEVER);break;case lr:i.depthFunc(i.ALWAYS);break;case cr:i.depthFunc(i.LESS);break;case Wn:i.depthFunc(i.LEQUAL);break;case hr:i.depthFunc(i.EQUAL);break;case ur:i.depthFunc(i.GEQUAL);break;case dr:i.depthFunc(i.GREATER);break;case fr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Z=lt}},setLocked:function(lt){R=lt},setClear:function(lt){ct!==lt&&(it&&(lt=1-lt),i.clearDepth(lt),ct=lt)},reset:function(){R=!1,k=null,Z=null,ct=null,it=!1}}}function s(){let R=!1,it=null,k=null,Z=null,ct=null,lt=null,Pt=null,re=null,me=null;return{setTest:function(Jt){R||(Jt?at(i.STENCIL_TEST):Et(i.STENCIL_TEST))},setMask:function(Jt){it!==Jt&&!R&&(i.stencilMask(Jt),it=Jt)},setFunc:function(Jt,Ge,an){(k!==Jt||Z!==Ge||ct!==an)&&(i.stencilFunc(Jt,Ge,an),k=Jt,Z=Ge,ct=an)},setOp:function(Jt,Ge,an){(lt!==Jt||Pt!==Ge||re!==an)&&(i.stencilOp(Jt,Ge,an),lt=Jt,Pt=Ge,re=an)},setLocked:function(Jt){R=Jt},setClear:function(Jt){me!==Jt&&(i.clearStencil(Jt),me=Jt)},reset:function(){R=!1,it=null,k=null,Z=null,ct=null,lt=null,Pt=null,re=null,me=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,h={},d={},f=new WeakMap,m=[],x=null,y=!1,p=null,u=null,T=null,w=null,b=null,D=null,A=null,I=new Yt(0,0,0),U=0,M=!1,v=null,C=null,q=null,z=null,W=null,K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),H=!1,tt=0,V=i.getParameter(i.VERSION);V.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(V)[1]),H=tt>=1):V.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),H=tt>=2);let rt=null,ut={},yt=i.getParameter(i.SCISSOR_BOX),Ut=i.getParameter(i.VIEWPORT),Qt=new ne().fromArray(yt),X=new ne().fromArray(Ut);function et(R,it,k,Z){let ct=new Uint8Array(4),lt=i.createTexture();i.bindTexture(R,lt),i.texParameteri(R,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(R,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pt=0;Pt<k;Pt++)R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY?i.texImage3D(it,0,i.RGBA,1,1,Z,0,i.RGBA,i.UNSIGNED_BYTE,ct):i.texImage2D(it+Pt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ct);return lt}let _t={};_t[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),_t[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),_t[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),_t[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),at(i.DEPTH_TEST),a.setFunc(Wn),Ot(!1),Bt(La),at(i.CULL_FACE),E(_n);function at(R){h[R]!==!0&&(i.enable(R),h[R]=!0)}function Et(R){h[R]!==!1&&(i.disable(R),h[R]=!1)}function Xt(R,it){return d[R]!==it?(i.bindFramebuffer(R,it),d[R]=it,R===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=it),R===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=it),!0):!1}function Tt(R,it){let k=m,Z=!1;if(R){k=f.get(it),k===void 0&&(k=[],f.set(it,k));let ct=R.textures;if(k.length!==ct.length||k[0]!==i.COLOR_ATTACHMENT0){for(let lt=0,Pt=ct.length;lt<Pt;lt++)k[lt]=i.COLOR_ATTACHMENT0+lt;k.length=ct.length,Z=!0}}else k[0]!==i.BACK&&(k[0]=i.BACK,Z=!0);Z&&i.drawBuffers(k)}function oe(R){return x!==R?(i.useProgram(R),x=R,!0):!1}let ie={[An]:i.FUNC_ADD,[Ko]:i.FUNC_SUBTRACT,[Qo]:i.FUNC_REVERSE_SUBTRACT};ie[jo]=i.MIN,ie[tl]=i.MAX;let Ft={[el]:i.ZERO,[nl]:i.ONE,[il]:i.SRC_COLOR,[Ns]:i.SRC_ALPHA,[cl]:i.SRC_ALPHA_SATURATE,[ol]:i.DST_COLOR,[rl]:i.DST_ALPHA,[sl]:i.ONE_MINUS_SRC_COLOR,[Fs]:i.ONE_MINUS_SRC_ALPHA,[ll]:i.ONE_MINUS_DST_COLOR,[al]:i.ONE_MINUS_DST_ALPHA,[hl]:i.CONSTANT_COLOR,[ul]:i.ONE_MINUS_CONSTANT_COLOR,[dl]:i.CONSTANT_ALPHA,[fl]:i.ONE_MINUS_CONSTANT_ALPHA};function E(R,it,k,Z,ct,lt,Pt,re,me,Jt){if(R===_n){y===!0&&(Et(i.BLEND),y=!1);return}if(y===!1&&(at(i.BLEND),y=!0),R!==Jo){if(R!==p||Jt!==M){if((u!==An||b!==An)&&(i.blendEquation(i.FUNC_ADD),u=An,b=An),Jt)switch(R){case Gn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ua:i.blendFunc(i.ONE,i.ONE);break;case Na:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Fa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Gn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ua:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Na:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Fa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}T=null,w=null,D=null,A=null,I.set(0,0,0),U=0,p=R,M=Jt}return}ct=ct||it,lt=lt||k,Pt=Pt||Z,(it!==u||ct!==b)&&(i.blendEquationSeparate(ie[it],ie[ct]),u=it,b=ct),(k!==T||Z!==w||lt!==D||Pt!==A)&&(i.blendFuncSeparate(Ft[k],Ft[Z],Ft[lt],Ft[Pt]),T=k,w=Z,D=lt,A=Pt),(re.equals(I)===!1||me!==U)&&(i.blendColor(re.r,re.g,re.b,me),I.copy(re),U=me),p=R,M=!1}function Ue(R,it){R.side===Ve?Et(i.CULL_FACE):at(i.CULL_FACE);let k=R.side===Se;it&&(k=!k),Ot(k),R.blending===Gn&&R.transparent===!1?E(_n):E(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),a.setFunc(R.depthFunc),a.setTest(R.depthTest),a.setMask(R.depthWrite),r.setMask(R.colorWrite);let Z=R.stencilWrite;o.setTest(Z),Z&&(o.setMask(R.stencilWriteMask),o.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),o.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),te(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?at(i.SAMPLE_ALPHA_TO_COVERAGE):Et(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ot(R){v!==R&&(R?i.frontFace(i.CW):i.frontFace(i.CCW),v=R)}function Bt(R){R!==Yo?(at(i.CULL_FACE),R!==C&&(R===La?i.cullFace(i.BACK):R===$o?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Et(i.CULL_FACE),C=R}function Mt(R){R!==q&&(H&&i.lineWidth(R),q=R)}function te(R,it,k){R?(at(i.POLYGON_OFFSET_FILL),(z!==it||W!==k)&&(i.polygonOffset(it,k),z=it,W=k)):Et(i.POLYGON_OFFSET_FILL)}function vt(R){R?at(i.SCISSOR_TEST):Et(i.SCISSOR_TEST)}function S(R){R===void 0&&(R=i.TEXTURE0+K-1),rt!==R&&(i.activeTexture(R),rt=R)}function g(R,it,k){k===void 0&&(rt===null?k=i.TEXTURE0+K-1:k=rt);let Z=ut[k];Z===void 0&&(Z={type:void 0,texture:void 0},ut[k]=Z),(Z.type!==R||Z.texture!==it)&&(rt!==k&&(i.activeTexture(k),rt=k),i.bindTexture(R,it||_t[R]),Z.type=R,Z.texture=it)}function N(){let R=ut[rt];R!==void 0&&R.type!==void 0&&(i.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function G(){try{i.texSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function xt(){try{i.texSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ot(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function dt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function kt(){try{i.texStorage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function j(){try{i.texStorage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ft(){try{i.texImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function wt(){try{i.texImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function At(R){Qt.equals(R)===!1&&(i.scissor(R.x,R.y,R.z,R.w),Qt.copy(R))}function pt(R){X.equals(R)===!1&&(i.viewport(R.x,R.y,R.z,R.w),X.copy(R))}function zt(R,it){let k=c.get(it);k===void 0&&(k=new WeakMap,c.set(it,k));let Z=k.get(R);Z===void 0&&(Z=i.getUniformBlockIndex(it,R.name),k.set(R,Z))}function Lt(R,it){let Z=c.get(it).get(R);l.get(it)!==Z&&(i.uniformBlockBinding(it,Z,R.__bindingPointIndex),l.set(it,Z))}function jt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},rt=null,ut={},d={},f=new WeakMap,m=[],x=null,y=!1,p=null,u=null,T=null,w=null,b=null,D=null,A=null,I=new Yt(0,0,0),U=0,M=!1,v=null,C=null,q=null,z=null,W=null,Qt.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:at,disable:Et,bindFramebuffer:Xt,drawBuffers:Tt,useProgram:oe,setBlending:E,setMaterial:Ue,setFlipSided:Ot,setCullFace:Bt,setLineWidth:Mt,setPolygonOffset:te,setScissorTest:vt,activeTexture:S,bindTexture:g,unbindTexture:N,compressedTexImage2D:Y,compressedTexImage3D:J,texImage2D:ft,texImage3D:wt,updateUBOMapping:zt,uniformBlockBinding:Lt,texStorage2D:kt,texStorage3D:j,texSubImage2D:G,texSubImage3D:xt,compressedTexSubImage2D:ot,compressedTexSubImage3D:dt,scissor:At,viewport:pt,reset:jt}}function Cp(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Wt,h=new WeakMap,d,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(S,g){return m?new OffscreenCanvas(S,g):xi("canvas")}function y(S,g,N){let Y=1,J=vt(S);if((J.width>N||J.height>N)&&(Y=N/Math.max(J.width,J.height)),Y<1)if(typeof HTMLImageElement!="undefined"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&S instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&S instanceof ImageBitmap||typeof VideoFrame!="undefined"&&S instanceof VideoFrame){let G=Math.floor(Y*J.width),xt=Math.floor(Y*J.height);d===void 0&&(d=x(G,xt));let ot=g?x(G,xt):d;return ot.width=G,ot.height=xt,ot.getContext("2d").drawImage(S,0,0,G,xt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+G+"x"+xt+")."),ot}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),S;return S}function p(S){return S.generateMipmaps}function u(S){i.generateMipmap(S)}function T(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function w(S,g,N,Y,J=!1){if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let G=g;if(g===i.RED&&(N===i.FLOAT&&(G=i.R32F),N===i.HALF_FLOAT&&(G=i.R16F),N===i.UNSIGNED_BYTE&&(G=i.R8)),g===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(G=i.R8UI),N===i.UNSIGNED_SHORT&&(G=i.R16UI),N===i.UNSIGNED_INT&&(G=i.R32UI),N===i.BYTE&&(G=i.R8I),N===i.SHORT&&(G=i.R16I),N===i.INT&&(G=i.R32I)),g===i.RG&&(N===i.FLOAT&&(G=i.RG32F),N===i.HALF_FLOAT&&(G=i.RG16F),N===i.UNSIGNED_BYTE&&(G=i.RG8)),g===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(G=i.RG8UI),N===i.UNSIGNED_SHORT&&(G=i.RG16UI),N===i.UNSIGNED_INT&&(G=i.RG32UI),N===i.BYTE&&(G=i.RG8I),N===i.SHORT&&(G=i.RG16I),N===i.INT&&(G=i.RG32I)),g===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(G=i.RGB8UI),N===i.UNSIGNED_SHORT&&(G=i.RGB16UI),N===i.UNSIGNED_INT&&(G=i.RGB32UI),N===i.BYTE&&(G=i.RGB8I),N===i.SHORT&&(G=i.RGB16I),N===i.INT&&(G=i.RGB32I)),g===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(G=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(G=i.RGBA16UI),N===i.UNSIGNED_INT&&(G=i.RGBA32UI),N===i.BYTE&&(G=i.RGBA8I),N===i.SHORT&&(G=i.RGBA16I),N===i.INT&&(G=i.RGBA32I)),g===i.RGB&&N===i.UNSIGNED_INT_5_9_9_9_REV&&(G=i.RGB9_E5),g===i.RGBA){let xt=J?Hi:Ht.getTransfer(Y);N===i.FLOAT&&(G=i.RGBA32F),N===i.HALF_FLOAT&&(G=i.RGBA16F),N===i.UNSIGNED_BYTE&&(G=xt===Kt?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(G=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(G=i.RGB5_A1)}return(G===i.R16F||G===i.R32F||G===i.RG16F||G===i.RG32F||G===i.RGBA16F||G===i.RGBA32F)&&t.get("EXT_color_buffer_float"),G}function b(S,g){let N;return S?g===null||g===Ln||g===Kn?N=i.DEPTH24_STENCIL8:g===sn?N=i.DEPTH32F_STENCIL8:g===Si&&(N=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ln||g===Kn?N=i.DEPTH_COMPONENT24:g===sn?N=i.DEPTH_COMPONENT32F:g===Si&&(N=i.DEPTH_COMPONENT16),N}function D(S,g){return p(S)===!0||S.isFramebufferTexture&&S.minFilter!==Be&&S.minFilter!==Le?Math.log2(Math.max(g.width,g.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?g.mipmaps.length:1}function A(S){let g=S.target;g.removeEventListener("dispose",A),U(g),g.isVideoTexture&&h.delete(g)}function I(S){let g=S.target;g.removeEventListener("dispose",I),v(g)}function U(S){let g=n.get(S);if(g.__webglInit===void 0)return;let N=S.source,Y=f.get(N);if(Y){let J=Y[g.__cacheKey];J.usedTimes--,J.usedTimes===0&&M(S),Object.keys(Y).length===0&&f.delete(N)}n.remove(S)}function M(S){let g=n.get(S);i.deleteTexture(g.__webglTexture);let N=S.source,Y=f.get(N);delete Y[g.__cacheKey],a.memory.textures--}function v(S){let g=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let J=0;J<g.__webglFramebuffer[Y].length;J++)i.deleteFramebuffer(g.__webglFramebuffer[Y][J]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}let N=S.textures;for(let Y=0,J=N.length;Y<J;Y++){let G=n.get(N[Y]);G.__webglTexture&&(i.deleteTexture(G.__webglTexture),a.memory.textures--),n.remove(N[Y])}n.remove(S)}let C=0;function q(){C=0}function z(){let S=C;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),C+=1,S}function W(S){let g=[];return g.push(S.wrapS),g.push(S.wrapT),g.push(S.wrapR||0),g.push(S.magFilter),g.push(S.minFilter),g.push(S.anisotropy),g.push(S.internalFormat),g.push(S.format),g.push(S.type),g.push(S.generateMipmaps),g.push(S.premultiplyAlpha),g.push(S.flipY),g.push(S.unpackAlignment),g.push(S.colorSpace),g.join()}function K(S,g){let N=n.get(S);if(S.isVideoTexture&&Mt(S),S.isRenderTargetTexture===!1&&S.version>0&&N.__version!==S.version){let Y=S.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(N,S,g);return}}e.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+g)}function H(S,g){let N=n.get(S);if(S.version>0&&N.__version!==S.version){X(N,S,g);return}e.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+g)}function tt(S,g){let N=n.get(S);if(S.version>0&&N.__version!==S.version){X(N,S,g);return}e.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+g)}function V(S,g){let N=n.get(S);if(S.version>0&&N.__version!==S.version){et(N,S,g);return}e.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+g)}let rt={[Os]:i.REPEAT,[Tn]:i.CLAMP_TO_EDGE,[Bs]:i.MIRRORED_REPEAT},ut={[Be]:i.NEAREST,[bl]:i.NEAREST_MIPMAP_NEAREST,[ss]:i.NEAREST_MIPMAP_LINEAR,[Le]:i.LINEAR,[gr]:i.LINEAR_MIPMAP_NEAREST,[en]:i.LINEAR_MIPMAP_LINEAR},yt={[Cl]:i.NEVER,[Ul]:i.ALWAYS,[Rl]:i.LESS,[Za]:i.LEQUAL,[Il]:i.EQUAL,[Dl]:i.GEQUAL,[Pl]:i.GREATER,[Ll]:i.NOTEQUAL};function Ut(S,g){if(g.type===sn&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Le||g.magFilter===gr||g.magFilter===ss||g.magFilter===en||g.minFilter===Le||g.minFilter===gr||g.minFilter===ss||g.minFilter===en)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,rt[g.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,rt[g.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,rt[g.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,ut[g.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,ut[g.minFilter]),g.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,yt[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Be||g.minFilter!==ss&&g.minFilter!==en||g.type===sn&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){let N=t.get("EXT_texture_filter_anisotropic");i.texParameterf(S,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Qt(S,g){let N=!1;S.__webglInit===void 0&&(S.__webglInit=!0,g.addEventListener("dispose",A));let Y=g.source,J=f.get(Y);J===void 0&&(J={},f.set(Y,J));let G=W(g);if(G!==S.__cacheKey){J[G]===void 0&&(J[G]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,N=!0),J[G].usedTimes++;let xt=J[S.__cacheKey];xt!==void 0&&(J[S.__cacheKey].usedTimes--,xt.usedTimes===0&&M(g)),S.__cacheKey=G,S.__webglTexture=J[G].texture}return N}function X(S,g,N){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);let J=Qt(S,g),G=g.source;e.bindTexture(Y,S.__webglTexture,i.TEXTURE0+N);let xt=n.get(G);if(G.version!==xt.__version||J===!0){e.activeTexture(i.TEXTURE0+N);let ot=Ht.getPrimaries(Ht.workingColorSpace),dt=g.colorSpace===vn?null:Ht.getPrimaries(g.colorSpace),kt=g.colorSpace===vn||ot===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);let j=y(g.image,!1,s.maxTextureSize);j=te(g,j);let ft=r.convert(g.format,g.colorSpace),wt=r.convert(g.type),At=w(g.internalFormat,ft,wt,g.colorSpace,g.isVideoTexture);Ut(Y,g);let pt,zt=g.mipmaps,Lt=g.isVideoTexture!==!0,jt=xt.__version===void 0||J===!0,R=G.dataReady,it=D(g,j);if(g.isDepthTexture)At=b(g.format===Xn,g.type),jt&&(Lt?e.texStorage2D(i.TEXTURE_2D,1,At,j.width,j.height):e.texImage2D(i.TEXTURE_2D,0,At,j.width,j.height,0,ft,wt,null));else if(g.isDataTexture)if(zt.length>0){Lt&&jt&&e.texStorage2D(i.TEXTURE_2D,it,At,zt[0].width,zt[0].height);for(let k=0,Z=zt.length;k<Z;k++)pt=zt[k],Lt?R&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,pt.width,pt.height,ft,wt,pt.data):e.texImage2D(i.TEXTURE_2D,k,At,pt.width,pt.height,0,ft,wt,pt.data);g.generateMipmaps=!1}else Lt?(jt&&e.texStorage2D(i.TEXTURE_2D,it,At,j.width,j.height),R&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,j.width,j.height,ft,wt,j.data)):e.texImage2D(i.TEXTURE_2D,0,At,j.width,j.height,0,ft,wt,j.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Lt&&jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,zt[0].width,zt[0].height,j.depth);for(let k=0,Z=zt.length;k<Z;k++)if(pt=zt[k],g.format!==He)if(ft!==null)if(Lt){if(R)if(g.layerUpdates.size>0){let ct=eo(pt.width,pt.height,g.format,g.type);for(let lt of g.layerUpdates){let Pt=pt.data.subarray(lt*ct/pt.data.BYTES_PER_ELEMENT,(lt+1)*ct/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,lt,pt.width,pt.height,1,ft,Pt)}g.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,pt.width,pt.height,j.depth,ft,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,k,At,pt.width,pt.height,j.depth,0,pt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?R&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,pt.width,pt.height,j.depth,ft,wt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,k,At,pt.width,pt.height,j.depth,0,ft,wt,pt.data)}else{Lt&&jt&&e.texStorage2D(i.TEXTURE_2D,it,At,zt[0].width,zt[0].height);for(let k=0,Z=zt.length;k<Z;k++)pt=zt[k],g.format!==He?ft!==null?Lt?R&&e.compressedTexSubImage2D(i.TEXTURE_2D,k,0,0,pt.width,pt.height,ft,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,k,At,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?R&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,pt.width,pt.height,ft,wt,pt.data):e.texImage2D(i.TEXTURE_2D,k,At,pt.width,pt.height,0,ft,wt,pt.data)}else if(g.isDataArrayTexture)if(Lt){if(jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,j.width,j.height,j.depth),R)if(g.layerUpdates.size>0){let k=eo(j.width,j.height,g.format,g.type);for(let Z of g.layerUpdates){let ct=j.data.subarray(Z*k/j.data.BYTES_PER_ELEMENT,(Z+1)*k/j.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,j.width,j.height,1,ft,wt,ct)}g.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ft,wt,j.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,j.width,j.height,j.depth,0,ft,wt,j.data);else if(g.isData3DTexture)Lt?(jt&&e.texStorage3D(i.TEXTURE_3D,it,At,j.width,j.height,j.depth),R&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ft,wt,j.data)):e.texImage3D(i.TEXTURE_3D,0,At,j.width,j.height,j.depth,0,ft,wt,j.data);else if(g.isFramebufferTexture){if(jt)if(Lt)e.texStorage2D(i.TEXTURE_2D,it,At,j.width,j.height);else{let k=j.width,Z=j.height;for(let ct=0;ct<it;ct++)e.texImage2D(i.TEXTURE_2D,ct,At,k,Z,0,ft,wt,null),k>>=1,Z>>=1}}else if(zt.length>0){if(Lt&&jt){let k=vt(zt[0]);e.texStorage2D(i.TEXTURE_2D,it,At,k.width,k.height)}for(let k=0,Z=zt.length;k<Z;k++)pt=zt[k],Lt?R&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,ft,wt,pt):e.texImage2D(i.TEXTURE_2D,k,At,ft,wt,pt);g.generateMipmaps=!1}else if(Lt){if(jt){let k=vt(j);e.texStorage2D(i.TEXTURE_2D,it,At,k.width,k.height)}R&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ft,wt,j)}else e.texImage2D(i.TEXTURE_2D,0,At,ft,wt,j);p(g)&&u(Y),xt.__version=G.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function et(S,g,N){if(g.image.length!==6)return;let Y=Qt(S,g),J=g.source;e.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+N);let G=n.get(J);if(J.version!==G.__version||Y===!0){e.activeTexture(i.TEXTURE0+N);let xt=Ht.getPrimaries(Ht.workingColorSpace),ot=g.colorSpace===vn?null:Ht.getPrimaries(g.colorSpace),dt=g.colorSpace===vn||xt===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);let kt=g.isCompressedTexture||g.image[0].isCompressedTexture,j=g.image[0]&&g.image[0].isDataTexture,ft=[];for(let Z=0;Z<6;Z++)!kt&&!j?ft[Z]=y(g.image[Z],!0,s.maxCubemapSize):ft[Z]=j?g.image[Z].image:g.image[Z],ft[Z]=te(g,ft[Z]);let wt=ft[0],At=r.convert(g.format,g.colorSpace),pt=r.convert(g.type),zt=w(g.internalFormat,At,pt,g.colorSpace),Lt=g.isVideoTexture!==!0,jt=G.__version===void 0||Y===!0,R=J.dataReady,it=D(g,wt);Ut(i.TEXTURE_CUBE_MAP,g);let k;if(kt){Lt&&jt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,it,zt,wt.width,wt.height);for(let Z=0;Z<6;Z++){k=ft[Z].mipmaps;for(let ct=0;ct<k.length;ct++){let lt=k[ct];g.format!==He?At!==null?Lt?R&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,0,0,lt.width,lt.height,At,lt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,zt,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,0,0,lt.width,lt.height,At,pt,lt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,zt,lt.width,lt.height,0,At,pt,lt.data)}}}else{if(k=g.mipmaps,Lt&&jt){k.length>0&&it++;let Z=vt(ft[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,it,zt,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(j){Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ft[Z].width,ft[Z].height,At,pt,ft[Z].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,zt,ft[Z].width,ft[Z].height,0,At,pt,ft[Z].data);for(let ct=0;ct<k.length;ct++){let Pt=k[ct].image[Z].image;Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,0,0,Pt.width,Pt.height,At,pt,Pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,zt,Pt.width,Pt.height,0,At,pt,Pt.data)}}else{Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,At,pt,ft[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,zt,At,pt,ft[Z]);for(let ct=0;ct<k.length;ct++){let lt=k[ct];Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,0,0,At,pt,lt.image[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,zt,At,pt,lt.image[Z])}}}p(g)&&u(i.TEXTURE_CUBE_MAP),G.__version=J.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function _t(S,g,N,Y,J,G){let xt=r.convert(N.format,N.colorSpace),ot=r.convert(N.type),dt=w(N.internalFormat,xt,ot,N.colorSpace),kt=n.get(g),j=n.get(N);if(j.__renderTarget=g,!kt.__hasExternalTextures){let ft=Math.max(1,g.width>>G),wt=Math.max(1,g.height>>G);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,G,dt,ft,wt,g.depth,0,xt,ot,null):e.texImage2D(J,G,dt,ft,wt,0,xt,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,S),Bt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,J,j.__webglTexture,0,Ot(g)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,J,j.__webglTexture,G),e.bindFramebuffer(i.FRAMEBUFFER,null)}function at(S,g,N){if(i.bindRenderbuffer(i.RENDERBUFFER,S),g.depthBuffer){let Y=g.depthTexture,J=Y&&Y.isDepthTexture?Y.type:null,G=b(g.stencilBuffer,J),xt=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=Ot(g);Bt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot,G,g.width,g.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot,G,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,G,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,xt,i.RENDERBUFFER,S)}else{let Y=g.textures;for(let J=0;J<Y.length;J++){let G=Y[J],xt=r.convert(G.format,G.colorSpace),ot=r.convert(G.type),dt=w(G.internalFormat,xt,ot,G.colorSpace),kt=Ot(g);N&&Bt(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,kt,dt,g.width,g.height):Bt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,kt,dt,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,dt,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Et(S,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,S),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let Y=n.get(g.depthTexture);Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K(g.depthTexture,0);let J=Y.__webglTexture,G=Ot(g);if(g.depthTexture.format===Hn)Bt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(g.depthTexture.format===Xn)Bt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Xt(S){let g=n.get(S),N=S.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==S.depthTexture){let Y=S.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){let J=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",J)};Y.addEventListener("dispose",J),g.__depthDisposeCallback=J}g.__boundDepthTexture=Y}if(S.depthTexture&&!g.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");Et(g.__webglFramebuffer,S)}else if(N){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),at(g.__webglDepthbuffer[Y],S,!1);else{let J=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,G)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),at(g.__webglDepthbuffer,S,!1);else{let Y=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,J)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Tt(S,g,N){let Y=n.get(S);g!==void 0&&_t(Y.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&Xt(S)}function oe(S){let g=S.texture,N=n.get(S),Y=n.get(g);S.addEventListener("dispose",I);let J=S.textures,G=S.isWebGLCubeRenderTarget===!0,xt=J.length>1;if(xt||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,a.memory.textures++),G){N.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer[ot]=[];for(let dt=0;dt<g.mipmaps.length;dt++)N.__webglFramebuffer[ot][dt]=i.createFramebuffer()}else N.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer=[];for(let ot=0;ot<g.mipmaps.length;ot++)N.__webglFramebuffer[ot]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(xt)for(let ot=0,dt=J.length;ot<dt;ot++){let kt=n.get(J[ot]);kt.__webglTexture===void 0&&(kt.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&Bt(S)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ot=0;ot<J.length;ot++){let dt=J[ot];N.__webglColorRenderbuffer[ot]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[ot]);let kt=r.convert(dt.format,dt.colorSpace),j=r.convert(dt.type),ft=w(dt.internalFormat,kt,j,dt.colorSpace,S.isXRRenderTarget===!0),wt=Ot(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,wt,ft,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ot,i.RENDERBUFFER,N.__webglColorRenderbuffer[ot])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),at(N.__webglDepthRenderbuffer,S,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(G){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Ut(i.TEXTURE_CUBE_MAP,g);for(let ot=0;ot<6;ot++)if(g.mipmaps&&g.mipmaps.length>0)for(let dt=0;dt<g.mipmaps.length;dt++)_t(N.__webglFramebuffer[ot][dt],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,dt);else _t(N.__webglFramebuffer[ot],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);p(g)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(xt){for(let ot=0,dt=J.length;ot<dt;ot++){let kt=J[ot],j=n.get(kt);e.bindTexture(i.TEXTURE_2D,j.__webglTexture),Ut(i.TEXTURE_2D,kt),_t(N.__webglFramebuffer,S,kt,i.COLOR_ATTACHMENT0+ot,i.TEXTURE_2D,0),p(kt)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ot=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,Y.__webglTexture),Ut(ot,g),g.mipmaps&&g.mipmaps.length>0)for(let dt=0;dt<g.mipmaps.length;dt++)_t(N.__webglFramebuffer[dt],S,g,i.COLOR_ATTACHMENT0,ot,dt);else _t(N.__webglFramebuffer,S,g,i.COLOR_ATTACHMENT0,ot,0);p(g)&&u(ot),e.unbindTexture()}S.depthBuffer&&Xt(S)}function ie(S){let g=S.textures;for(let N=0,Y=g.length;N<Y;N++){let J=g[N];if(p(J)){let G=T(S),xt=n.get(J).__webglTexture;e.bindTexture(G,xt),u(G),e.unbindTexture()}}}let Ft=[],E=[];function Ue(S){if(S.samples>0){if(Bt(S)===!1){let g=S.textures,N=S.width,Y=S.height,J=i.COLOR_BUFFER_BIT,G=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xt=n.get(S),ot=g.length>1;if(ot)for(let dt=0;dt<g.length;dt++)e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,xt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglFramebuffer);for(let dt=0;dt<g.length;dt++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ot){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,xt.__webglColorRenderbuffer[dt]);let kt=n.get(g[dt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,kt,0)}i.blitFramebuffer(0,0,N,Y,0,0,N,Y,J,i.NEAREST),l===!0&&(Ft.length=0,E.length=0,Ft.push(i.COLOR_ATTACHMENT0+dt),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ft.push(G),E.push(G),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,E)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ft))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ot)for(let dt=0;dt<g.length;dt++){e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,xt.__webglColorRenderbuffer[dt]);let kt=n.get(g[dt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,kt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){let g=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Ot(S){return Math.min(s.maxSamples,S.samples)}function Bt(S){let g=n.get(S);return S.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Mt(S){let g=a.render.frame;h.get(S)!==g&&(h.set(S,g),S.update())}function te(S,g){let N=S.colorSpace,Y=S.format,J=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||N!==qn&&N!==vn&&(Ht.getTransfer(N)===Kt?(Y!==He||J!==nn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),g}function vt(S){return typeof HTMLImageElement!="undefined"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame!="undefined"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=q,this.setTexture2D=K,this.setTexture2DArray=H,this.setTexture3D=tt,this.setTextureCube=V,this.rebindTextures=Tt,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=ie,this.updateMultisampleRenderTarget=Ue,this.setupDepthRenderbuffer=Xt,this.setupFrameBufferTexture=_t,this.useMultisampledRTT=Bt}function Rp(i,t){function e(n,s=vn){let r,a=Ht.getTransfer(s);if(n===nn)return i.UNSIGNED_BYTE;if(n===xr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===vr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Va)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===za)return i.BYTE;if(n===ka)return i.SHORT;if(n===Si)return i.UNSIGNED_SHORT;if(n===_r)return i.INT;if(n===Ln)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===bi)return i.HALF_FLOAT;if(n===Ha)return i.ALPHA;if(n===Ga)return i.RGB;if(n===He)return i.RGBA;if(n===Wa)return i.LUMINANCE;if(n===Xa)return i.LUMINANCE_ALPHA;if(n===Hn)return i.DEPTH_COMPONENT;if(n===Xn)return i.DEPTH_STENCIL;if(n===qa)return i.RED;if(n===yr)return i.RED_INTEGER;if(n===Ya)return i.RG;if(n===Mr)return i.RG_INTEGER;if(n===Sr)return i.RGBA_INTEGER;if(n===rs||n===as||n===os||n===ls)if(a===Kt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===rs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===as)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===os)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ls)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===rs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===as)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===os)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ls)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===br||n===wr||n===Er||n===Tr)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===br)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===wr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Er)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Tr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ar||n===Cr||n===Rr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ar||n===Cr)return a===Kt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Rr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ir||n===Pr||n===Lr||n===Dr||n===Ur||n===Nr||n===Fr||n===Or||n===Br||n===zr||n===kr||n===Vr||n===Hr||n===Gr)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ir)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Pr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Lr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Dr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ur)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Nr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Fr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Or)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Br)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===zr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===kr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Vr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Hr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Gr)return a===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===cs||n===Wr||n===Xr)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===cs)return a===Kt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Wr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===$a||n===qr||n===Yr||n===$r)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===cs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===qr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Yr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===$r)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Kn?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var Ip=`
void main() {
...
}`,mo=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){let s=new fe,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new De({vertexShader:Ip,fragmentShader:Pp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Te(new gn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},go=class extends pn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,d=null,f=null,m=null,x=null,y=new mo,p=e.getContextAttributes(),u=null,T=null,w=[],b=[],D=new Wt,A=null,I=new xe;I.viewport=new ne;let U=new xe;U.viewport=new ne;let M=[I,U],v=new rr,C=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let et=w[X];return et===void 0&&(et=new yi,w[X]=et),et.getTargetRaySpace()},this.getControllerGrip=function(X){let et=w[X];return et===void 0&&(et=new yi,w[X]=et),et.getGripSpace()},this.getHand=function(X){let et=w[X];return et===void 0&&(et=new yi,w[X]=et),et.getHandSpace()};function z(X){let et=b.indexOf(X.inputSource);if(et===-1)return;let _t=w[et];_t!==void 0&&(_t.update(X.inputSource,X.frame,c||a),_t.dispatchEvent({type:X.type,data:X.inputSource}))}function W(){s.removeEventListener("select",z),s.removeEventListener("selectstart",z),s.removeEventListener("selectend",z),s.removeEventListener("squeeze",z),s.removeEventListener("squeezestart",z),s.removeEventListener("squeezeend",z),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",K);for(let X=0;X<w.length;X++){let et=b[X];et!==null&&(b[X]=null,w[X].disconnect(et))}C=null,q=null,y.reset(),t.setRenderTarget(u),m=null,f=null,d=null,s=null,T=null,Qt.stop(),n.isPresenting=!1,t.setPixelRatio(A),t.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return x},this.getSession=function(){return s},this.setSession=async function(X){if(s=X,s!==null){if(u=t.getRenderTarget(),s.addEventListener("select",z),s.addEventListener("selectstart",z),s.addEventListener("selectend",z),s.addEventListener("squeeze",z),s.addEventListener("squeezestart",z),s.addEventListener("squeezeend",z),s.addEventListener("end",W),s.addEventListener("inputsourceschange",K),p.xrCompatible!==!0&&await e.makeXRCompatible(),A=t.getPixelRatio(),t.getSize(D),typeof XRWebGLBinding!="undefined"&&"createProjectionLayer"in XRWebGLBinding.prototype){let _t=null,at=null,Et=null;p.depth&&(Et=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,_t=p.stencil?Xn:Hn,at=p.stencil?Kn:Ln);let Xt={colorFormat:e.RGBA8,depthFormat:Et,scaleFactor:r};d=new XRWebGLBinding(s,e),f=d.createProjectionLayer(Xt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new Qe(f.textureWidth,f.textureHeight,{format:He,type:nn,depthTexture:new ts(f.textureWidth,f.textureHeight,at,void 0,void 0,void 0,void 0,void 0,void 0,_t),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}else{let _t={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,e,_t),s.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),T=new Qe(m.framebufferWidth,m.framebufferHeight,{format:He,type:nn,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Qt.setContext(s),Qt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function K(X){for(let et=0;et<X.removed.length;et++){let _t=X.removed[et],at=b.indexOf(_t);at>=0&&(b[at]=null,w[at].disconnect(_t))}for(let et=0;et<X.added.length;et++){let _t=X.added[et],at=b.indexOf(_t);if(at===-1){for(let Xt=0;Xt<w.length;Xt++)if(Xt>=b.length){b.push(_t),at=Xt;break}else if(b[Xt]===null){b[Xt]=_t,at=Xt;break}if(at===-1)break}let Et=w[at];Et&&Et.connect(_t)}}let H=new B,tt=new B;function V(X,et,_t){H.setFromMatrixPosition(et.matrixWorld),tt.setFromMatrixPosition(_t.matrixWorld);let at=H.distanceTo(tt),Et=et.projectionMatrix.elements,Xt=_t.projectionMatrix.elements,Tt=Et[14]/(Et[10]-1),oe=Et[14]/(Et[10]+1),ie=(Et[9]+1)/Et[5],Ft=(Et[9]-1)/Et[5],E=(Et[8]-1)/Et[0],Ue=(Xt[8]+1)/Xt[0],Ot=Tt*E,Bt=Tt*Ue,Mt=at/(-E+Ue),te=Mt*-E;if(et.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(te),X.translateZ(Mt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Et[10]===-1)X.projectionMatrix.copy(et.projectionMatrix),X.projectionMatrixInverse.copy(et.projectionMatrixInverse);else{let vt=Tt+Mt,S=oe+Mt,g=Ot-te,N=Bt+(at-te),Y=ie*oe/S*vt,J=Ft*oe/S*vt;X.projectionMatrix.makePerspective(g,N,Y,J,vt,S),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function rt(X,et){et===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(et.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(s===null)return;let et=X.near,_t=X.far;y.texture!==null&&(y.depthNear>0&&(et=y.depthNear),y.depthFar>0&&(_t=y.depthFar)),v.near=U.near=I.near=et,v.far=U.far=I.far=_t,(C!==v.near||q!==v.far)&&(s.updateRenderState({depthNear:v.near,depthFar:v.far}),C=v.near,q=v.far),I.layers.mask=X.layers.mask|2,U.layers.mask=X.layers.mask|4,v.layers.mask=I.layers.mask|U.layers.mask;let at=X.parent,Et=v.cameras;rt(v,at);for(let Xt=0;Xt<Et.length;Xt++)rt(Et[Xt],at);Et.length===2?V(v,I,U):v.projectionMatrix.copy(I.projectionMatrix),ut(X,v,at)};function ut(X,et,_t){_t===null?X.matrix.copy(et.matrixWorld):(X.matrix.copy(_t.matrixWorld),X.matrix.invert(),X.matrix.multiply(et.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(et.projectionMatrix),X.projectionMatrixInverse.copy(et.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=ks*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(X){l=X,f!==null&&(f.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(v)};let yt=null;function Ut(X,et){if(h=et.getViewerPose(c||a),x=et,h!==null){let _t=h.views;m!==null&&(t.setRenderTargetFramebuffer(T,m.framebuffer),t.setRenderTarget(T));let at=!1;_t.length!==v.cameras.length&&(v.cameras.length=0,at=!0);for(let Tt=0;Tt<_t.length;Tt++){let oe=_t[Tt],ie=null;if(m!==null)ie=m.getViewport(oe);else{let E=d.getViewSubImage(f,oe);ie=E.viewport,Tt===0&&(t.setRenderTargetTextures(T,E.colorTexture,f.ignoreDepthValues?void 0:E.depthStencilTexture),t.setRenderTarget(T))}let Ft=M[Tt];Ft===void 0&&(Ft=new xe,Ft.layers.enable(Tt),Ft.viewport=new ne,M[Tt]=Ft),Ft.matrix.fromArray(oe.transform.matrix),Ft.matrix.decompose(Ft.position,Ft.quaternion,Ft.scale),Ft.projectionMatrix.fromArray(oe.projectionMatrix),Ft.projectionMatrixInverse.copy(Ft.projectionMatrix).invert(),Ft.viewport.set(ie.x,ie.y,ie.width,ie.height),Tt===0&&(v.matrix.copy(Ft.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),at===!0&&v.cameras.push(Ft)}let Et=s.enabledFeatures;if(Et&&Et.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&d){let Tt=d.getDepthInformation(_t[0]);Tt&&Tt.isValid&&Tt.texture&&y.init(t,Tt,s.renderState)}}for(let _t=0;_t<w.length;_t++){let at=b[_t],Et=w[_t];at!==null&&Et!==void 0&&Et.update(at,et,c||a)}yt&&yt(X,et),et.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:et}),x=null}let Qt=new uc;Qt.setAnimationLoop(Ut),this.setAnimationLoop=function(X){yt=X},this.dispose=function(){}}},ei=new ze,Lp=new se;function Dp(i,t){function e(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function n(p,u){u.color.getRGB(p.fogColor.value,Qa(i)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function s(p,u,T,w,b){u.isMeshBasicMaterial||u.isMeshLambertMaterial?r(p,u):u.isMeshToonMaterial?(r(p,u),d(p,u)):u.isMeshPhongMaterial?(r(p,u),h(p,u)):u.isMeshStandardMaterial?(r(p,u),f(p,u),u.isMeshPhysicalMaterial&&m(p,u,b)):u.isMeshMatcapMaterial?(r(p,u),x(p,u)):u.isMeshDepthMaterial?r(p,u):u.isMeshDistanceMaterial?(r(p,u),y(p,u)):u.isMeshNormalMaterial?r(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?l(p,u,T,w):u.isSpriteMaterial?c(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,e(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Se&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,e(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Se&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,e(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,e(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,e(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);let T=t.get(u),w=T.envMap,b=T.envMapRotation;w&&(p.envMap.value=w,ei.copy(b),ei.x*=-1,ei.y*=-1,ei.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(ei.y*=-1,ei.z*=-1),p.envMapRotation.value.setFromMatrix4(Lp.makeRotationFromEuler(ei)),p.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,e(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,e(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function l(p,u,T,w){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*T,p.scale.value=w*.5,u.map&&(p.map.value=u.map,e(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function c(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function h(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function d(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function f(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,e(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,e(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,T){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,e(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,e(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,e(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,e(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,e(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Se&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,e(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,e(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=T.texture,p.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,e(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,e(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,e(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,e(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,e(u.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,u){u.matcap&&(p.matcap.value=u.matcap)}function y(p,u){let T=t.get(u).light;p.referencePosition.value.setFromMatrixPosition(T.matrixWorld),p.nearDistance.value=T.shadow.camera.near,p.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Up(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,w){let b=w.program;n.uniformBlockBinding(T,b)}function c(T,w){let b=s[T.id];b===void 0&&(x(T),b=h(T),s[T.id]=b,T.addEventListener("dispose",p));let D=w.program;n.updateUBOMapping(T,D);let A=t.render.frame;r[T.id]!==A&&(f(T),r[T.id]=A)}function h(T){let w=d();T.__bindingPointIndex=w;let b=i.createBuffer(),D=T.__size,A=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,D,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,b),b}function d(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){let w=s[T.id],b=T.uniforms,D=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let A=0,I=b.length;A<I;A++){let U=Array.isArray(b[A])?b[A]:[b[A]];for(let M=0,v=U.length;M<v;M++){let C=U[M];if(m(C,A,M,D)===!0){let q=C.__offset,z=Array.isArray(C.value)?C.value:[C.value],W=0;for(let K=0;K<z.length;K++){let H=z[K],tt=y(H);typeof H=="number"||typeof H=="boolean"?(C.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,q+W,C.__data)):H.isMatrix3?(C.__data[0]=H.elements[0],C.__data[1]=H.elements[1],C.__data[2]=H.elements[2],C.__data[3]=0,C.__data[4]=H.elements[3],C.__data[5]=H.elements[4],C.__data[6]=H.elements[5],C.__data[7]=0,C.__data[8]=H.elements[6],C.__data[9]=H.elements[7],C.__data[10]=H.elements[8],C.__data[11]=0):(H.toArray(C.__data,W),W+=tt.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,q,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(T,w,b,D){let A=T.value,I=w+"_"+b;if(D[I]===void 0)return typeof A=="number"||typeof A=="boolean"?D[I]=A:D[I]=A.clone(),!0;{let U=D[I];if(typeof A=="number"||typeof A=="boolean"){if(U!==A)return D[I]=A,!0}else if(U.equals(A)===!1)return U.copy(A),!0}return!1}function x(T){let w=T.uniforms,b=0,D=16;for(let I=0,U=w.length;I<U;I++){let M=Array.isArray(w[I])?w[I]:[w[I]];for(let v=0,C=M.length;v<C;v++){let q=M[v],z=Array.isArray(q.value)?q.value:[q.value];for(let W=0,K=z.length;W<K;W++){let H=z[W],tt=y(H),V=b%D,rt=V%tt.boundary,ut=V+rt;b+=rt,ut!==0&&D-ut<tt.storage&&(b+=D-ut),q.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),q.__offset=b,b+=tt.storage}}}let A=b%D;return A>0&&(b+=D-A),T.__size=b,T.__cache={},this}function y(T){let w={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(w.boundary=4,w.storage=4):T.isVector2?(w.boundary=8,w.storage=8):T.isVector3||T.isColor?(w.boundary=16,w.storage=12):T.isVector4?(w.boundary=16,w.storage=16):T.isMatrix3?(w.boundary=48,w.storage=48):T.isMatrix4?(w.boundary=64,w.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),w}function p(T){let w=T.target;w.removeEventListener("dispose",p);let b=a.indexOf(w.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function u(){for(let T in s)i.deleteBuffer(s[T]);a=[],s={},r={}}return{bind:l,update:c,dispose:u}}var jr=class{constructor(t={}){let{canvas:e=Nl(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext!="undefined"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;let x=new Uint32Array(4),y=new Int32Array(4),p=null,u=null,T=[],w=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ie,this.toneMapping=xn,this.toneMappingExposure=1;let b=this,D=!1,A=0,I=0,U=null,M=-1,v=null,C=new ne,q=new ne,z=null,W=new Yt(0),K=0,H=e.width,tt=e.height,V=1,rt=null,ut=null,yt=new ne(0,0,H,tt),Ut=new ne(0,0,H,tt),Qt=!1,X=new ji,et=!1,_t=!1;this.transmissionResolutionScale=1;let at=new se,Et=new se,Xt=new B,Tt=new ne,oe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ie=!1;function Ft(){return U===null?V:1}let E=n;function Ue(_,P){return e.getContext(_,P)}try{let _={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ar}`),e.addEventListener("webglcontextlost",Z,!1),e.addEventListener("webglcontextrestored",ct,!1),e.addEventListener("webglcontextcreationerror",lt,!1),E===null){let P="webgl2";if(E=Ue(P,_),E===null)throw Ue(P)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(_){throw console.error("THREE.WebGLRenderer: "+_.message),_}let Ot,Bt,Mt,te,vt,S,g,N,Y,J,G,xt,ot,dt,kt,j,ft,wt,At,pt,zt,Lt,jt,R;function it(){Ot=new Kd(E),Ot.init(),Lt=new Rp(E,Ot),Bt=new Xd(E,Ot,t,Lt),Mt=new Ap(E,Ot),Bt.reverseDepthBuffer&&f&&Mt.buffers.depth.setReversed(!0),te=new tf(E),vt=new pp,S=new Cp(E,Ot,Mt,vt,Bt,Lt,te),g=new Yd(b),N=new Jd(b),Y=new oh(E),jt=new Gd(E,Y),J=new Qd(E,Y,te,jt),G=new nf(E,J,Y,te),At=new ef(E,Bt,S),j=new qd(vt),xt=new fp(b,g,N,Ot,Bt,jt,j),ot=new Dp(b,vt),dt=new gp,kt=new Sp(Ot),wt=new Hd(b,g,N,Mt,G,m,l),ft=new Ep(b,G,Bt),R=new Up(E,te,Bt,Mt),pt=new Wd(E,Ot,te),zt=new jd(E,Ot,te),te.programs=xt.programs,b.capabilities=Bt,b.extensions=Ot,b.properties=vt,b.renderLists=dt,b.shadowMap=ft,b.state=Mt,b.info=te}it();let k=new go(b,E);this.xr=k,this.getContext=function(){return E},this.getContextAttributes=function(){return E.getContextAttributes()},this.forceContextLoss=function(){let _=Ot.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){let _=Ot.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(_){_!==void 0&&(V=_,this.setSize(H,tt,!1))},this.getSize=function(_){return _.set(H,tt)},this.setSize=function(_,P,F=!0){if(k.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=_,tt=P,e.width=Math.floor(_*V),e.height=Math.floor(P*V),F===!0&&(e.style.width=_+"px",e.style.height=P+"px"),this.setViewport(0,0,_,P)},this.getDrawingBufferSize=function(_){return _.set(H*V,tt*V).floor()},this.setDrawingBufferSize=function(_,P,F){H=_,tt=P,V=F,e.width=Math.floor(_*F),e.height=Math.floor(P*F),this.setViewport(0,0,_,P)},this.getCurrentViewport=function(_){return _.copy(C)},this.getViewport=function(_){return _.copy(yt)},this.setViewport=function(_,P,F,O){_.isVector4?yt.set(_.x,_.y,_.z,_.w):yt.set(_,P,F,O),Mt.viewport(C.copy(yt).multiplyScalar(V).round())},this.getScissor=function(_){return _.copy(Ut)},this.setScissor=function(_,P,F,O){_.isVector4?Ut.set(_.x,_.y,_.z,_.w):Ut.set(_,P,F,O),Mt.scissor(q.copy(Ut).multiplyScalar(V).round())},this.getScissorTest=function(){return Qt},this.setScissorTest=function(_){Mt.setScissorTest(Qt=_)},this.setOpaqueSort=function(_){rt=_},this.setTransparentSort=function(_){ut=_},this.getClearColor=function(_){return _.copy(wt.getClearColor())},this.setClearColor=function(){wt.setClearColor.apply(wt,arguments)},this.getClearAlpha=function(){return wt.getClearAlpha()},this.setClearAlpha=function(){wt.setClearAlpha.apply(wt,arguments)},this.clear=function(_=!0,P=!0,F=!0){let O=0;if(_){let L=!1;if(U!==null){let Q=U.texture.format;L=Q===Sr||Q===Mr||Q===yr}if(L){let Q=U.texture.type,st=Q===nn||Q===Ln||Q===Si||Q===Kn||Q===xr||Q===vr,ht=wt.getClearColor(),mt=wt.getClearAlpha(),Ct=ht.r,Rt=ht.g,St=ht.b;st?(x[0]=Ct,x[1]=Rt,x[2]=St,x[3]=mt,E.clearBufferuiv(E.COLOR,0,x)):(y[0]=Ct,y[1]=Rt,y[2]=St,y[3]=mt,E.clearBufferiv(E.COLOR,0,y))}else O|=E.COLOR_BUFFER_BIT}P&&(O|=E.DEPTH_BUFFER_BIT),F&&(O|=E.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),E.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Z,!1),e.removeEventListener("webglcontextrestored",ct,!1),e.removeEventListener("webglcontextcreationerror",lt,!1),wt.dispose(),dt.dispose(),kt.dispose(),vt.dispose(),g.dispose(),N.dispose(),G.dispose(),jt.dispose(),R.dispose(),xt.dispose(),k.dispose(),k.removeEventListener("sessionstart",yo),k.removeEventListener("sessionend",Mo),Dn.stop()};function Z(_){_.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function ct(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;let _=te.autoReset,P=ft.enabled,F=ft.autoUpdate,O=ft.needsUpdate,L=ft.type;it(),te.autoReset=_,ft.enabled=P,ft.autoUpdate=F,ft.needsUpdate=O,ft.type=L}function lt(_){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function Pt(_){let P=_.target;P.removeEventListener("dispose",Pt),re(P)}function re(_){me(_),vt.remove(_)}function me(_){let P=vt.get(_).programs;P!==void 0&&(P.forEach(function(F){xt.releaseProgram(F)}),_.isShaderMaterial&&xt.releaseShaderCache(_))}this.renderBufferDirect=function(_,P,F,O,L,Q){P===null&&(P=oe);let st=L.isMesh&&L.matrixWorld.determinant()<0,ht=xc(_,P,F,O,L);Mt.setMaterial(O,st);let mt=F.index,Ct=1;if(O.wireframe===!0){if(mt=J.getWireframeAttribute(F),mt===void 0)return;Ct=2}let Rt=F.drawRange,St=F.attributes.position,Vt=Rt.start*Ct,$t=(Rt.start+Rt.count)*Ct;Q!==null&&(Vt=Math.max(Vt,Q.start*Ct),$t=Math.min($t,(Q.start+Q.count)*Ct)),mt!==null?(Vt=Math.max(Vt,0),$t=Math.min($t,mt.count)):St!=null&&(Vt=Math.max(Vt,0),$t=Math.min($t,St.count));let le=$t-Vt;if(le<0||le===1/0)return;jt.setup(L,O,ht,F,mt);let ae,Gt=pt;if(mt!==null&&(ae=Y.get(mt),Gt=zt,Gt.setIndex(ae)),L.isMesh)O.wireframe===!0?(Mt.setLineWidth(O.wireframeLinewidth*Ft()),Gt.setMode(E.LINES)):Gt.setMode(E.TRIANGLES);else if(L.isLine){let bt=O.linewidth;bt===void 0&&(bt=1),Mt.setLineWidth(bt*Ft()),L.isLineSegments?Gt.setMode(E.LINES):L.isLineLoop?Gt.setMode(E.LINE_LOOP):Gt.setMode(E.LINE_STRIP)}else L.isPoints?Gt.setMode(E.POINTS):L.isSprite&&Gt.setMode(E.TRIANGLES);if(L.isBatchedMesh)if(L._multiDrawInstances!==null)Gt.renderMultiDrawInstances(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount,L._multiDrawInstances);else if(Ot.get("WEBGL_multi_draw"))Gt.renderMultiDraw(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount);else{let bt=L._multiDrawStarts,pe=L._multiDrawCounts,Zt=L._multiDrawCount,We=mt?Y.get(mt).bytesPerElement:1,si=vt.get(O).currentProgram.getUniforms();for(let Ae=0;Ae<Zt;Ae++)si.setValue(E,"_gl_DrawID",Ae),Gt.render(bt[Ae]/We,pe[Ae])}else if(L.isInstancedMesh)Gt.renderInstances(Vt,le,L.count);else if(F.isInstancedBufferGeometry){let bt=F._maxInstanceCount!==void 0?F._maxInstanceCount:1/0,pe=Math.min(F.instanceCount,bt);Gt.renderInstances(Vt,le,pe)}else Gt.render(Vt,le)};function Jt(_,P,F){_.transparent===!0&&_.side===Ve&&_.forceSinglePass===!1?(_.side=Se,_.needsUpdate=!0,ps(_,P,F),_.side=fn,_.needsUpdate=!0,ps(_,P,F),_.side=Ve):ps(_,P,F)}this.compile=function(_,P,F=null){F===null&&(F=_),u=kt.get(F),u.init(P),w.push(u),F.traverseVisible(function(L){L.isLight&&L.layers.test(P.layers)&&(u.pushLight(L),L.castShadow&&u.pushShadow(L))}),_!==F&&_.traverseVisible(function(L){L.isLight&&L.layers.test(P.layers)&&(u.pushLight(L),L.castShadow&&u.pushShadow(L))}),u.setupLights();let O=new Set;return _.traverse(function(L){if(!(L.isMesh||L.isPoints||L.isLine||L.isSprite))return;let Q=L.material;if(Q)if(Array.isArray(Q))for(let st=0;st<Q.length;st++){let ht=Q[st];Jt(ht,F,L),O.add(ht)}else Jt(Q,F,L),O.add(Q)}),w.pop(),u=null,O},this.compileAsync=function(_,P,F=null){let O=this.compile(_,P,F);return new Promise(L=>{function Q(){if(O.forEach(function(st){vt.get(st).currentProgram.isReady()&&O.delete(st)}),O.size===0){L(_);return}setTimeout(Q,10)}Ot.get("KHR_parallel_shader_compile")!==null?Q():setTimeout(Q,10)})};let Ge=null;function an(_){Ge&&Ge(_)}function yo(){Dn.stop()}function Mo(){Dn.start()}let Dn=new uc;Dn.setAnimationLoop(an),typeof self!="undefined"&&Dn.setContext(self),this.setAnimationLoop=function(_){Ge=_,k.setAnimationLoop(_),_===null?Dn.stop():Dn.start()},k.addEventListener("sessionstart",yo),k.addEventListener("sessionend",Mo),this.render=function(_,P){if(P!==void 0&&P.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),P.parent===null&&P.matrixWorldAutoUpdate===!0&&P.updateMatrixWorld(),k.enabled===!0&&k.isPresenting===!0&&(k.cameraAutoUpdate===!0&&k.updateCamera(P),P=k.getCamera()),_.isScene===!0&&_.onBeforeRender(b,_,P,U),u=kt.get(_,w.length),u.init(P),w.push(u),Et.multiplyMatrices(P.projectionMatrix,P.matrixWorldInverse),X.setFromProjectionMatrix(Et),_t=this.localClippingEnabled,et=j.init(this.clippingPlanes,_t),p=dt.get(_,T.length),p.init(),T.push(p),k.enabled===!0&&k.isPresenting===!0){let Q=b.xr.getDepthSensingMesh();Q!==null&&ea(Q,P,-1/0,b.sortObjects)}ea(_,P,0,b.sortObjects),p.finish(),b.sortObjects===!0&&p.sort(rt,ut),ie=k.enabled===!1||k.isPresenting===!1||k.hasDepthSensing()===!1,ie&&wt.addToRenderList(p,_),this.info.render.frame++,et===!0&&j.beginShadows();let F=u.state.shadowsArray;ft.render(F,_,P),et===!0&&j.endShadows(),this.info.autoReset===!0&&this.info.reset();let O=p.opaque,L=p.transmissive;if(u.setupLights(),P.isArrayCamera){let Q=P.cameras;if(L.length>0)for(let st=0,ht=Q.length;st<ht;st++){let mt=Q[st];bo(O,L,_,mt)}ie&&wt.render(_);for(let st=0,ht=Q.length;st<ht;st++){let mt=Q[st];So(p,_,mt,mt.viewport)}}else L.length>0&&bo(O,L,_,P),ie&&wt.render(_),So(p,_,P);U!==null&&I===0&&(S.updateMultisampleRenderTarget(U),S.updateRenderTargetMipmap(U)),_.isScene===!0&&_.onAfterRender(b,_,P),jt.resetDefaultState(),M=-1,v=null,w.pop(),w.length>0?(u=w[w.length-1],et===!0&&j.setGlobalState(b.clippingPlanes,u.state.camera)):u=null,T.pop(),T.length>0?p=T[T.length-1]:p=null};function ea(_,P,F,O){if(_.visible===!1)return;if(_.layers.test(P.layers)){if(_.isGroup)F=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(P);else if(_.isLight)u.pushLight(_),_.castShadow&&u.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||X.intersectsSprite(_)){O&&Tt.setFromMatrixPosition(_.matrixWorld).applyMatrix4(Et);let st=G.update(_),ht=_.material;ht.visible&&p.push(_,st,ht,F,Tt.z,null)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||X.intersectsObject(_))){let st=G.update(_),ht=_.material;if(O&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),Tt.copy(_.boundingSphere.center)):(st.boundingSphere===null&&st.computeBoundingSphere(),Tt.copy(st.boundingSphere.center)),Tt.applyMatrix4(_.matrixWorld).applyMatrix4(Et)),Array.isArray(ht)){let mt=st.groups;for(let Ct=0,Rt=mt.length;Ct<Rt;Ct++){let St=mt[Ct],Vt=ht[St.materialIndex];Vt&&Vt.visible&&p.push(_,st,Vt,F,Tt.z,St)}}else ht.visible&&p.push(_,st,ht,F,Tt.z,null)}}let Q=_.children;for(let st=0,ht=Q.length;st<ht;st++)ea(Q[st],P,F,O)}function So(_,P,F,O){let L=_.opaque,Q=_.transmissive,st=_.transparent;u.setupLightsView(F),et===!0&&j.setGlobalState(b.clippingPlanes,F),O&&Mt.viewport(C.copy(O)),L.length>0&&fs(L,P,F),Q.length>0&&fs(Q,P,F),st.length>0&&fs(st,P,F),Mt.buffers.depth.setTest(!0),Mt.buffers.depth.setMask(!0),Mt.buffers.color.setMask(!0),Mt.setPolygonOffset(!1)}function bo(_,P,F,O){if((F.isScene===!0?F.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[O.id]===void 0&&(u.state.transmissionRenderTarget[O.id]=new Qe(1,1,{generateMipmaps:!0,type:Ot.has("EXT_color_buffer_half_float")||Ot.has("EXT_color_buffer_float")?bi:nn,minFilter:en,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ht.workingColorSpace}));let Q=u.state.transmissionRenderTarget[O.id],st=O.viewport||C;Q.setSize(st.z*b.transmissionResolutionScale,st.w*b.transmissionResolutionScale);let ht=b.getRenderTarget();b.setRenderTarget(Q),b.getClearColor(W),K=b.getClearAlpha(),K<1&&b.setClearColor(16777215,.5),b.clear(),ie&&wt.render(F);let mt=b.toneMapping;b.toneMapping=xn;let Ct=O.viewport;if(O.viewport!==void 0&&(O.viewport=void 0),u.setupLightsView(O),et===!0&&j.setGlobalState(b.clippingPlanes,O),fs(_,F,O),S.updateMultisampleRenderTarget(Q),S.updateRenderTargetMipmap(Q),Ot.has("WEBGL_multisampled_render_to_texture")===!1){let Rt=!1;for(let St=0,Vt=P.length;St<Vt;St++){let $t=P[St],le=$t.object,ae=$t.geometry,Gt=$t.material,bt=$t.group;if(Gt.side===Ve&&le.layers.test(O.layers)){let pe=Gt.side;Gt.side=Se,Gt.needsUpdate=!0,wo(le,F,O,ae,Gt,bt),Gt.side=pe,Gt.needsUpdate=!0,Rt=!0}}Rt===!0&&(S.updateMultisampleRenderTarget(Q),S.updateRenderTargetMipmap(Q))}b.setRenderTarget(ht),b.setClearColor(W,K),Ct!==void 0&&(O.viewport=Ct),b.toneMapping=mt}function fs(_,P,F){let O=P.isScene===!0?P.overrideMaterial:null;for(let L=0,Q=_.length;L<Q;L++){let st=_[L],ht=st.object,mt=st.geometry,Ct=O===null?st.material:O,Rt=st.group;ht.layers.test(F.layers)&&wo(ht,P,F,mt,Ct,Rt)}}function wo(_,P,F,O,L,Q){_.onBeforeRender(b,P,F,O,L,Q),_.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),L.onBeforeRender(b,P,F,O,_,Q),L.transparent===!0&&L.side===Ve&&L.forceSinglePass===!1?(L.side=Se,L.needsUpdate=!0,b.renderBufferDirect(F,P,O,L,_,Q),L.side=fn,L.needsUpdate=!0,b.renderBufferDirect(F,P,O,L,_,Q),L.side=Ve):b.renderBufferDirect(F,P,O,L,_,Q),_.onAfterRender(b,P,F,O,L,Q)}function ps(_,P,F){P.isScene!==!0&&(P=oe);let O=vt.get(_),L=u.state.lights,Q=u.state.shadowsArray,st=L.state.version,ht=xt.getParameters(_,L.state,Q,P,F),mt=xt.getProgramCacheKey(ht),Ct=O.programs;O.environment=_.isMeshStandardMaterial?P.environment:null,O.fog=P.fog,O.envMap=(_.isMeshStandardMaterial?N:g).get(_.envMap||O.environment),O.envMapRotation=O.environment!==null&&_.envMap===null?P.environmentRotation:_.envMapRotation,Ct===void 0&&(_.addEventListener("dispose",Pt),Ct=new Map,O.programs=Ct);let Rt=Ct.get(mt);if(Rt!==void 0){if(O.currentProgram===Rt&&O.lightsStateVersion===st)return To(_,ht),Rt}else ht.uniforms=xt.getUniforms(_),_.onBeforeCompile(ht,b),Rt=xt.acquireProgram(ht,mt),Ct.set(mt,Rt),O.uniforms=ht.uniforms;let St=O.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(St.clippingPlanes=j.uniform),To(_,ht),O.needsLights=yc(_),O.lightsStateVersion=st,O.needsLights&&(St.ambientLightColor.value=L.state.ambient,St.lightProbe.value=L.state.probe,St.directionalLights.value=L.state.directional,St.directionalLightShadows.value=L.state.directionalShadow,St.spotLights.value=L.state.spot,St.spotLightShadows.value=L.state.spotShadow,St.rectAreaLights.value=L.state.rectArea,St.ltc_1.value=L.state.rectAreaLTC1,St.ltc_2.value=L.state.rectAreaLTC2,St.pointLights.value=L.state.point,St.pointLightShadows.value=L.state.pointShadow,St.hemisphereLights.value=L.state.hemi,St.directionalShadowMap.value=L.state.directionalShadowMap,St.directionalShadowMatrix.value=L.state.directionalShadowMatrix,St.spotShadowMap.value=L.state.spotShadowMap,St.spotLightMatrix.value=L.state.spotLightMatrix,St.spotLightMap.value=L.state.spotLightMap,St.pointShadowMap.value=L.state.pointShadowMap,St.pointShadowMatrix.value=L.state.pointShadowMatrix),O.currentProgram=Rt,O.uniformsList=null,Rt}function Eo(_){if(_.uniformsList===null){let P=_.currentProgram.getUniforms();_.uniformsList=Ti.seqWithValue(P.seq,_.uniforms)}return _.uniformsList}function To(_,P){let F=vt.get(_);F.outputColorSpace=P.outputColorSpace,F.batching=P.batching,F.batchingColor=P.batchingColor,F.instancing=P.instancing,F.instancingColor=P.instancingColor,F.instancingMorph=P.instancingMorph,F.skinning=P.skinning,F.morphTargets=P.morphTargets,F.morphNormals=P.morphNormals,F.morphColors=P.morphColors,F.morphTargetsCount=P.morphTargetsCount,F.numClippingPlanes=P.numClippingPlanes,F.numIntersection=P.numClipIntersection,F.vertexAlphas=P.vertexAlphas,F.vertexTangents=P.vertexTangents,F.toneMapping=P.toneMapping}function xc(_,P,F,O,L){P.isScene!==!0&&(P=oe),S.resetTextureUnits();let Q=P.fog,st=O.isMeshStandardMaterial?P.environment:null,ht=U===null?b.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:qn,mt=(O.isMeshStandardMaterial?N:g).get(O.envMap||st),Ct=O.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,Rt=!!F.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),St=!!F.morphAttributes.position,Vt=!!F.morphAttributes.normal,$t=!!F.morphAttributes.color,le=xn;O.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(le=b.toneMapping);let ae=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,Gt=ae!==void 0?ae.length:0,bt=vt.get(O),pe=u.state.lights;if(et===!0&&(_t===!0||_!==v)){let Me=_===v&&O.id===M;j.setState(O,_,Me)}let Zt=!1;O.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==pe.state.version||bt.outputColorSpace!==ht||L.isBatchedMesh&&bt.batching===!1||!L.isBatchedMesh&&bt.batching===!0||L.isBatchedMesh&&bt.batchingColor===!0&&L.colorTexture===null||L.isBatchedMesh&&bt.batchingColor===!1&&L.colorTexture!==null||L.isInstancedMesh&&bt.instancing===!1||!L.isInstancedMesh&&bt.instancing===!0||L.isSkinnedMesh&&bt.skinning===!1||!L.isSkinnedMesh&&bt.skinning===!0||L.isInstancedMesh&&bt.instancingColor===!0&&L.instanceColor===null||L.isInstancedMesh&&bt.instancingColor===!1&&L.instanceColor!==null||L.isInstancedMesh&&bt.instancingMorph===!0&&L.morphTexture===null||L.isInstancedMesh&&bt.instancingMorph===!1&&L.morphTexture!==null||bt.envMap!==mt||O.fog===!0&&bt.fog!==Q||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==j.numPlanes||bt.numIntersection!==j.numIntersection)||bt.vertexAlphas!==Ct||bt.vertexTangents!==Rt||bt.morphTargets!==St||bt.morphNormals!==Vt||bt.morphColors!==$t||bt.toneMapping!==le||bt.morphTargetsCount!==Gt)&&(Zt=!0):(Zt=!0,bt.__version=O.version);let We=bt.currentProgram;Zt===!0&&(We=ps(O,P,L));let si=!1,Ae=!1,Ci=!1,ee=We.getUniforms(),Ne=bt.uniforms;if(Mt.useProgram(We.program)&&(si=!0,Ae=!0,Ci=!0),O.id!==M&&(M=O.id,Ae=!0),si||v!==_){Mt.buffers.depth.getReversed()?(at.copy(_.projectionMatrix),Ol(at),Bl(at),ee.setValue(E,"projectionMatrix",at)):ee.setValue(E,"projectionMatrix",_.projectionMatrix),ee.setValue(E,"viewMatrix",_.matrixWorldInverse);let be=ee.map.cameraPosition;be!==void 0&&be.setValue(E,Xt.setFromMatrixPosition(_.matrixWorld)),Bt.logarithmicDepthBuffer&&ee.setValue(E,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&ee.setValue(E,"isOrthographic",_.isOrthographicCamera===!0),v!==_&&(v=_,Ae=!0,Ci=!0)}if(L.isSkinnedMesh){ee.setOptional(E,L,"bindMatrix"),ee.setOptional(E,L,"bindMatrixInverse");let Me=L.skeleton;Me&&(Me.boneTexture===null&&Me.computeBoneTexture(),ee.setValue(E,"boneTexture",Me.boneTexture,S))}L.isBatchedMesh&&(ee.setOptional(E,L,"batchingTexture"),ee.setValue(E,"batchingTexture",L._matricesTexture,S),ee.setOptional(E,L,"batchingIdTexture"),ee.setValue(E,"batchingIdTexture",L._indirectTexture,S),ee.setOptional(E,L,"batchingColorTexture"),L._colorsTexture!==null&&ee.setValue(E,"batchingColorTexture",L._colorsTexture,S));let Fe=F.morphAttributes;if((Fe.position!==void 0||Fe.normal!==void 0||Fe.color!==void 0)&&At.update(L,F,We),(Ae||bt.receiveShadow!==L.receiveShadow)&&(bt.receiveShadow=L.receiveShadow,ee.setValue(E,"receiveShadow",L.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(Ne.envMap.value=mt,Ne.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),O.isMeshStandardMaterial&&O.envMap===null&&P.environment!==null&&(Ne.envMapIntensity.value=P.environmentIntensity),Ae&&(ee.setValue(E,"toneMappingExposure",b.toneMappingExposure),bt.needsLights&&vc(Ne,Ci),Q&&O.fog===!0&&ot.refreshFogUniforms(Ne,Q),ot.refreshMaterialUniforms(Ne,O,V,tt,u.state.transmissionRenderTarget[_.id]),Ti.upload(E,Eo(bt),Ne,S)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(Ti.upload(E,Eo(bt),Ne,S),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&ee.setValue(E,"center",L.center),ee.setValue(E,"modelViewMatrix",L.modelViewMatrix),ee.setValue(E,"normalMatrix",L.normalMatrix),ee.setValue(E,"modelMatrix",L.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){let Me=O.uniformsGroups;for(let be=0,na=Me.length;be<na;be++){let Un=Me[be];R.update(Un,We),R.bind(Un,We)}}return We}function vc(_,P){_.ambientLightColor.needsUpdate=P,_.lightProbe.needsUpdate=P,_.directionalLights.needsUpdate=P,_.directionalLightShadows.needsUpdate=P,_.pointLights.needsUpdate=P,_.pointLightShadows.needsUpdate=P,_.spotLights.needsUpdate=P,_.spotLightShadows.needsUpdate=P,_.rectAreaLights.needsUpdate=P,_.hemisphereLights.needsUpdate=P}function yc(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(_,P,F){vt.get(_.texture).__webglTexture=P,vt.get(_.depthTexture).__webglTexture=F;let O=vt.get(_);O.__hasExternalTextures=!0,O.__autoAllocateDepthBuffer=F===void 0,O.__autoAllocateDepthBuffer||Ot.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),O.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(_,P){let F=vt.get(_);F.__webglFramebuffer=P,F.__useDefaultFramebuffer=P===void 0};let Mc=E.createFramebuffer();this.setRenderTarget=function(_,P=0,F=0){U=_,A=P,I=F;let O=!0,L=null,Q=!1,st=!1;if(_){let mt=vt.get(_);if(mt.__useDefaultFramebuffer!==void 0)Mt.bindFramebuffer(E.FRAMEBUFFER,null),O=!1;else if(mt.__webglFramebuffer===void 0)S.setupRenderTarget(_);else if(mt.__hasExternalTextures)S.rebindTextures(_,vt.get(_.texture).__webglTexture,vt.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){let St=_.depthTexture;if(mt.__boundDepthTexture!==St){if(St!==null&&vt.has(St)&&(_.width!==St.image.width||_.height!==St.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(_)}}let Ct=_.texture;(Ct.isData3DTexture||Ct.isDataArrayTexture||Ct.isCompressedArrayTexture)&&(st=!0);let Rt=vt.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(Rt[P])?L=Rt[P][F]:L=Rt[P],Q=!0):_.samples>0&&S.useMultisampledRTT(_)===!1?L=vt.get(_).__webglMultisampledFramebuffer:Array.isArray(Rt)?L=Rt[F]:L=Rt,C.copy(_.viewport),q.copy(_.scissor),z=_.scissorTest}else C.copy(yt).multiplyScalar(V).floor(),q.copy(Ut).multiplyScalar(V).floor(),z=Qt;if(F!==0&&(L=Mc),Mt.bindFramebuffer(E.FRAMEBUFFER,L)&&O&&Mt.drawBuffers(_,L),Mt.viewport(C),Mt.scissor(q),Mt.setScissorTest(z),Q){let mt=vt.get(_.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_CUBE_MAP_POSITIVE_X+P,mt.__webglTexture,F)}else if(st){let mt=vt.get(_.texture),Ct=P;E.framebufferTextureLayer(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,mt.__webglTexture,F,Ct)}else if(_!==null&&F!==0){let mt=vt.get(_.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,mt.__webglTexture,F)}M=-1},this.readRenderTargetPixels=function(_,P,F,O,L,Q,st){if(!(_&&_.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ht=vt.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&st!==void 0&&(ht=ht[st]),ht){Mt.bindFramebuffer(E.FRAMEBUFFER,ht);try{let mt=_.texture,Ct=mt.format,Rt=mt.type;if(!Bt.textureFormatReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Bt.textureTypeReadable(Rt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}P>=0&&P<=_.width-O&&F>=0&&F<=_.height-L&&E.readPixels(P,F,O,L,Lt.convert(Ct),Lt.convert(Rt),Q)}finally{let mt=U!==null?vt.get(U).__webglFramebuffer:null;Mt.bindFramebuffer(E.FRAMEBUFFER,mt)}}},this.readRenderTargetPixelsAsync=async function(_,P,F,O,L,Q,st){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ht=vt.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&st!==void 0&&(ht=ht[st]),ht){let mt=_.texture,Ct=mt.format,Rt=mt.type;if(!Bt.textureFormatReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Bt.textureTypeReadable(Rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(P>=0&&P<=_.width-O&&F>=0&&F<=_.height-L){Mt.bindFramebuffer(E.FRAMEBUFFER,ht);let St=E.createBuffer();E.bindBuffer(E.PIXEL_PACK_BUFFER,St),E.bufferData(E.PIXEL_PACK_BUFFER,Q.byteLength,E.STREAM_READ),E.readPixels(P,F,O,L,Lt.convert(Ct),Lt.convert(Rt),0);let Vt=U!==null?vt.get(U).__webglFramebuffer:null;Mt.bindFramebuffer(E.FRAMEBUFFER,Vt);let $t=E.fenceSync(E.SYNC_GPU_COMMANDS_COMPLETE,0);return E.flush(),await Fl(E,$t,4),E.bindBuffer(E.PIXEL_PACK_BUFFER,St),E.getBufferSubData(E.PIXEL_PACK_BUFFER,0,Q),E.deleteBuffer(St),E.deleteSync($t),Q}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(_,P=null,F=0){_.isTexture!==!0&&(Qn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),P=arguments[0]||null,_=arguments[1]);let O=Math.pow(2,-F),L=Math.floor(_.image.width*O),Q=Math.floor(_.image.height*O),st=P!==null?P.x:0,ht=P!==null?P.y:0;S.setTexture2D(_,0),E.copyTexSubImage2D(E.TEXTURE_2D,F,0,0,st,ht,L,Q),Mt.unbindTexture()};let Sc=E.createFramebuffer(),bc=E.createFramebuffer();this.copyTextureToTexture=function(_,P,F=null,O=null,L=0,Q=null){_.isTexture!==!0&&(Qn("WebGLRenderer: copyTextureToTexture function signature has changed."),O=arguments[0]||null,_=arguments[1],P=arguments[2],Q=arguments[3]||0,F=null),Q===null&&(L!==0?(Qn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Q=L,L=0):Q=0);let st,ht,mt,Ct,Rt,St,Vt,$t,le,ae=_.isCompressedTexture?_.mipmaps[Q]:_.image;if(F!==null)st=F.max.x-F.min.x,ht=F.max.y-F.min.y,mt=F.isBox3?F.max.z-F.min.z:1,Ct=F.min.x,Rt=F.min.y,St=F.isBox3?F.min.z:0;else{let Fe=Math.pow(2,-L);st=Math.floor(ae.width*Fe),ht=Math.floor(ae.height*Fe),_.isDataArrayTexture?mt=ae.depth:_.isData3DTexture?mt=Math.floor(ae.depth*Fe):mt=1,Ct=0,Rt=0,St=0}O!==null?(Vt=O.x,$t=O.y,le=O.z):(Vt=0,$t=0,le=0);let Gt=Lt.convert(P.format),bt=Lt.convert(P.type),pe;P.isData3DTexture?(S.setTexture3D(P,0),pe=E.TEXTURE_3D):P.isDataArrayTexture||P.isCompressedArrayTexture?(S.setTexture2DArray(P,0),pe=E.TEXTURE_2D_ARRAY):(S.setTexture2D(P,0),pe=E.TEXTURE_2D),E.pixelStorei(E.UNPACK_FLIP_Y_WEBGL,P.flipY),E.pixelStorei(E.UNPACK_PREMULTIPLY_ALPHA_WEBGL,P.premultiplyAlpha),E.pixelStorei(E.UNPACK_ALIGNMENT,P.unpackAlignment);let Zt=E.getParameter(E.UNPACK_ROW_LENGTH),We=E.getParameter(E.UNPACK_IMAGE_HEIGHT),si=E.getParameter(E.UNPACK_SKIP_PIXELS),Ae=E.getParameter(E.UNPACK_SKIP_ROWS),Ci=E.getParameter(E.UNPACK_SKIP_IMAGES);E.pixelStorei(E.UNPACK_ROW_LENGTH,ae.width),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,ae.height),E.pixelStorei(E.UNPACK_SKIP_PIXELS,Ct),E.pixelStorei(E.UNPACK_SKIP_ROWS,Rt),E.pixelStorei(E.UNPACK_SKIP_IMAGES,St);let ee=_.isDataArrayTexture||_.isData3DTexture,Ne=P.isDataArrayTexture||P.isData3DTexture;if(_.isDepthTexture){let Fe=vt.get(_),Me=vt.get(P),be=vt.get(Fe.__renderTarget),na=vt.get(Me.__renderTarget);Mt.bindFramebuffer(E.READ_FRAMEBUFFER,be.__webglFramebuffer),Mt.bindFramebuffer(E.DRAW_FRAMEBUFFER,na.__webglFramebuffer);for(let Un=0;Un<mt;Un++)ee&&(E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,vt.get(_).__webglTexture,L,St+Un),E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,vt.get(P).__webglTexture,Q,le+Un)),E.blitFramebuffer(Ct,Rt,st,ht,Vt,$t,st,ht,E.DEPTH_BUFFER_BIT,E.NEAREST);Mt.bindFramebuffer(E.READ_FRAMEBUFFER,null),Mt.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else if(L!==0||_.isRenderTargetTexture||vt.has(_)){let Fe=vt.get(_),Me=vt.get(P);Mt.bindFramebuffer(E.READ_FRAMEBUFFER,Sc),Mt.bindFramebuffer(E.DRAW_FRAMEBUFFER,bc);for(let be=0;be<mt;be++)ee?E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Fe.__webglTexture,L,St+be):E.framebufferTexture2D(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Fe.__webglTexture,L),Ne?E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Me.__webglTexture,Q,le+be):E.framebufferTexture2D(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Me.__webglTexture,Q),L!==0?E.blitFramebuffer(Ct,Rt,st,ht,Vt,$t,st,ht,E.COLOR_BUFFER_BIT,E.NEAREST):Ne?E.copyTexSubImage3D(pe,Q,Vt,$t,le+be,Ct,Rt,st,ht):E.copyTexSubImage2D(pe,Q,Vt,$t,Ct,Rt,st,ht);Mt.bindFramebuffer(E.READ_FRAMEBUFFER,null),Mt.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else Ne?_.isDataTexture||_.isData3DTexture?E.texSubImage3D(pe,Q,Vt,$t,le,st,ht,mt,Gt,bt,ae.data):P.isCompressedArrayTexture?E.compressedTexSubImage3D(pe,Q,Vt,$t,le,st,ht,mt,Gt,ae.data):E.texSubImage3D(pe,Q,Vt,$t,le,st,ht,mt,Gt,bt,ae):_.isDataTexture?E.texSubImage2D(E.TEXTURE_2D,Q,Vt,$t,st,ht,Gt,bt,ae.data):_.isCompressedTexture?E.compressedTexSubImage2D(E.TEXTURE_2D,Q,Vt,$t,ae.width,ae.height,Gt,ae.data):E.texSubImage2D(E.TEXTURE_2D,Q,Vt,$t,st,ht,Gt,bt,ae);E.pixelStorei(E.UNPACK_ROW_LENGTH,Zt),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,We),E.pixelStorei(E.UNPACK_SKIP_PIXELS,si),E.pixelStorei(E.UNPACK_SKIP_ROWS,Ae),E.pixelStorei(E.UNPACK_SKIP_IMAGES,Ci),Q===0&&P.generateMipmaps&&E.generateMipmap(pe),Mt.unbindTexture()},this.copyTextureToTexture3D=function(_,P,F=null,O=null,L=0){return _.isTexture!==!0&&(Qn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),F=arguments[0]||null,O=arguments[1]||null,_=arguments[2],P=arguments[3],L=arguments[4]||0),Qn('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(_,P,F,O,L)},this.initRenderTarget=function(_){vt.get(_).__webglFramebuffer===void 0&&S.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?S.setTextureCube(_,0):_.isData3DTexture?S.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?S.setTexture2DArray(_,0):S.setTexture2D(_,0),Mt.unbindTexture()},this.resetState=function(){A=0,I=0,U=null,Mt.reset(),jt.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Je}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorspace=Ht._getDrawingBufferColorSpace(t),e.unpackColorSpace=Ht._getUnpackColorSpace()}};var xo="uniform sampler2D uTexture;uniform float uOpacity;varying vec2 vUv;void main(){vec4 texture=texture2D(uTexture,vUv);gl_FragColor=texture;gl_FragColor.a*=uOpacity;}";var gc="varying vec2 vUv;uniform float uTime;uniform float uManualTime;uniform float uSpeed;uniform float uElevation;uniform float uTwistFactor;uniform float uTwistFactor2;uniform vec2 uFrequency;uniform sampler2D uTexture;varying float twistPerlin2;vec4 permute(vec4 x){return mod(((x*34.0)+1.0)*x,289.0);}vec4 taylorInvSqrt(vec4 r){return 1.79284291400159-0.85373472095314*r;}vec3 fade(vec3 t){return t*t*t*(t*(t*6.0-15.0)+10.0);}float cnoise(vec3 P){vec3 Pi0=floor(P);vec3 Pi1=Pi0+vec3(1.0);Pi0=mod(Pi0,289.0);Pi1=mod(Pi1,289.0);vec3 Pf0=fract(P);vec3 Pf1=Pf0-vec3(1.0);vec4 ix=vec4(Pi0.x,Pi1.x,Pi0.x,Pi1.x);vec4 iy=vec4(Pi0.yy,Pi1.yy);vec4 iz0=Pi0.zzzz;vec4 iz1=Pi1.zzzz;vec4 ixy=permute(permute(ix)+iy);vec4 ixy0=permute(ixy+iz0);vec4 ixy1=permute(ixy+iz1);vec4 gx0=ixy0/7.0;vec4 gy0=fract(floor(gx0)/7.0)-0.5;gx0=fract(gx0);vec4 gz0=vec4(0.5)-abs(gx0)-abs(gy0);vec4 sz0=step(gz0,vec4(0.0));gx0-=sz0*(step(0.0,gx0)-0.5);gy0-=sz0*(step(0.0,gy0)-0.5);vec4 gx1=ixy1/7.0;vec4 gy1=fract(floor(gx1)/7.0)-0.5;gx1=fract(gx1);vec4 gz1=vec4(0.5)-abs(gx1)-abs(gy1);vec4 sz1=step(gz1,vec4(0.0));gx1-=sz1*(step(0.0,gx1)-0.5);gy1-=sz1*(step(0.0,gy1)-0.5);vec3 g000=vec3(gx0.x,gy0.x,gz0.x);vec3 g100=vec3(gx0.y,gy0.y,gz0.y);vec3 g010=vec3(gx0.z,gy0.z,gz0.z);vec3 g110=vec3(gx0.w,gy0.w,gz0.w);vec3 g001=vec3(gx1.x,gy1.x,gz1.x);vec3 g101=vec3(gx1.y,gy1.y,gz1.y);vec3 g011=vec3(gx1.z,gy1.z,gz1.z);vec3 g111=vec3(gx1.w,gy1.w,gz1.w);vec4 norm0=taylorInvSqrt(vec4(dot(g000,g000),dot(g010,g010),dot(g100,g100),dot(g110,g110)));g000*=norm0.x;g010*=norm0.y;g100*=norm0.z;g110*=norm0.w;vec4 norm1=taylorInvSqrt(vec4(dot(g001,g001),dot(g011,g011),dot(g101,g101),dot(g111,g111)));g001*=norm1.x;g011*=norm1.y;g101*=norm1.z;g111*=norm1.w;float n000=dot(g000,Pf0);float n100=dot(g100,vec3(Pf1.x,Pf0.yz));float n010=dot(g010,vec3(Pf0.x,Pf1.y,Pf0.z));float n110=dot(g110,vec3(Pf1.xy,Pf0.z));float n001=dot(g001,vec3(Pf0.xy,Pf1.z));float n101=dot(g101,vec3(Pf1.x,Pf0.y,Pf1.z));float n011=dot(g011,vec3(Pf0.x,Pf1.yz));float n111=dot(g111,Pf1);vec3 fade_xyz=fade(Pf0);vec4 n_z=mix(vec4(n000,n100,n010,n110),vec4(n001,n101,n011,n111),fade_xyz.z);vec2 n_yz=mix(n_z.xy,n_z.zw,fade_xyz.y);float n_xyz=mix(n_yz.x,n_yz.y,fade_xyz.x);return 2.2*n_xyz;}vec2 rotate2D(vec2 value,float angle){float s=sin(angle);float c=cos(angle);mat2 m=mat2(c,s,-s,c);return m*value;}void main(){vec3 newPosition=position;newPosition.x*=3.0;float elevation=sin(position.x*uFrequency.x+uManualTime*uSpeed)*sin(position.y*uFrequency.y+uManualTime*uSpeed)*uElevation;newPosition.xy+=elevation;float angle=newPosition.y*uTwistFactor*cnoise(vec3(newPosition.zx,uManualTime));float angle2=newPosition.y*uTwistFactor2*cnoise(vec3(newPosition.yz,uManualTime));newPosition.zy*=rotate2D(newPosition.zy,angle);gl_Position=projectionMatrix*modelViewMatrix*vec4(newPosition,1.0);vUv=uv;}";var _c="varying vec2 vUv;uniform float uTime;uniform float uManualTime;uniform float uSpeed;uniform float uElevation;uniform float uTwistFactor;uniform float uTwistFactor2;uniform vec2 uFrequency;uniform sampler2D uTexture;varying float twistPerlin2;vec4 permute(vec4 x){return mod(((x*34.0)+1.0)*x,289.0);}vec4 taylorInvSqrt(vec4 r){return 1.79284291400159-0.85373472095314*r;}vec3 fade(vec3 t){return t*t*t*(t*(t*6.0-15.0)+10.0);}float cnoise(vec3 P){vec3 Pi0=floor(P);vec3 Pi1=Pi0+vec3(1.0);Pi0=mod(Pi0,289.0);Pi1=mod(Pi1,289.0);vec3 Pf0=fract(P);vec3 Pf1=Pf0-vec3(1.0);vec4 ix=vec4(Pi0.x,Pi1.x,Pi0.x,Pi1.x);vec4 iy=vec4(Pi0.yy,Pi1.yy);vec4 iz0=Pi0.zzzz;vec4 iz1=Pi1.zzzz;vec4 ixy=permute(permute(ix)+iy);vec4 ixy0=permute(ixy+iz0);vec4 ixy1=permute(ixy+iz1);vec4 gx0=ixy0/7.0;vec4 gy0=fract(floor(gx0)/7.0)-0.5;gx0=fract(gx0);vec4 gz0=vec4(0.5)-abs(gx0)-abs(gy0);vec4 sz0=step(gz0,vec4(0.0));gx0-=sz0*(step(0.0,gx0)-0.5);gy0-=sz0*(step(0.0,gy0)-0.5);vec4 gx1=ixy1/7.0;vec4 gy1=fract(floor(gx1)/7.0)-0.5;gx1=fract(gx1);vec4 gz1=vec4(0.5)-abs(gx1)-abs(gy1);vec4 sz1=step(gz1,vec4(0.0));gx1-=sz1*(step(0.0,gx1)-0.5);gy1-=sz1*(step(0.0,gy1)-0.5);vec3 g000=vec3(gx0.x,gy0.x,gz0.x);vec3 g100=vec3(gx0.y,gy0.y,gz0.y);vec3 g010=vec3(gx0.z,gy0.z,gz0.z);vec3 g110=vec3(gx0.w,gy0.w,gz0.w);vec3 g001=vec3(gx1.x,gy1.x,gz1.x);vec3 g101=vec3(gx1.y,gy1.y,gz1.y);vec3 g011=vec3(gx1.z,gy1.z,gz1.z);vec3 g111=vec3(gx1.w,gy1.w,gz1.w);vec4 norm0=taylorInvSqrt(vec4(dot(g000,g000),dot(g010,g010),dot(g100,g100),dot(g110,g110)));g000*=norm0.x;g010*=norm0.y;g100*=norm0.z;g110*=norm0.w;vec4 norm1=taylorInvSqrt(vec4(dot(g001,g001),dot(g011,g011),dot(g101,g101),dot(g111,g111)));g001*=norm1.x;g011*=norm1.y;g101*=norm1.z;g111*=norm1.w;float n000=dot(g000,Pf0);float n100=dot(g100,vec3(Pf1.x,Pf0.yz));float n010=dot(g010,vec3(Pf0.x,Pf1.y,Pf0.z));float n110=dot(g110,vec3(Pf1.xy,Pf0.z));float n001=dot(g001,vec3(Pf0.xy,Pf1.z));float n101=dot(g101,vec3(Pf1.x,Pf0.y,Pf1.z));float n011=dot(g011,vec3(Pf0.x,Pf1.yz));float n111=dot(g111,Pf1);vec3 fade_xyz=fade(Pf0);vec4 n_z=mix(vec4(n000,n100,n010,n110),vec4(n001,n101,n011,n111),fade_xyz.z);vec2 n_yz=mix(n_z.xy,n_z.zw,fade_xyz.y);float n_xyz=mix(n_yz.x,n_yz.y,fade_xyz.x);return 2.2*n_xyz;}vec2 rotate2D(vec2 value,float angle){float s=sin(angle);float c=cos(angle);mat2 m=mat2(c,s,-s,c);return m*value;}void main(){vec3 newPosition=position;newPosition.x*=5.0;float elevation=sin(position.x*uFrequency.x+uManualTime*uSpeed)*sin(position.y*uFrequency.y+uManualTime*uSpeed)*uElevation;newPosition.xy+=elevation;float angle=newPosition.y*uTwistFactor*cnoise(vec3(newPosition.zx,uManualTime));float angle2=newPosition.y*uTwistFactor2*cnoise(vec3(newPosition.yz,uManualTime));newPosition.zy*=rotate2D(newPosition.zy,angle);gl_Position=projectionMatrix*modelViewMatrix*vec4(newPosition,1.0);vUv=uv;}";var ds=class{constructor(){gt(this,"scene");gt(this,"meshTop");gt(this,"meshBottom");gt(this,"_currentSection");gt(this,"_isMobile");gt(this,"preloaderComplete",!1);let t=document.createElement("canvas");t.classList.add("webgl"),t.style.zIndex="1",document.body.appendChild(t),this.scene=new Qi;let e={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{e.width=window.innerWidth,e.height=window.innerHeight,n.aspect=e.width/e.height,n.updateProjectionMatrix(),s.setSize(e.width,e.height),s.setPixelRatio(Math.min(window.devicePixelRatio,2))});let n=new xe(75,e.width/e.height,.1,100);n.position.set(.25,1,1.2),this.scene.add(n);let s=new jr({canvas:t,antialias:!0,alpha:!0,preserveDrawingBuffer:!0});s.setSize(e.width,e.height),s.setPixelRatio(Math.min(window.devicePixelRatio,2));let r=new ns().load("https://cdn.prod.website-files.com/67a51f5233734befd00d7699/67bf928a8f6ad5c62f6effc8_curved.png");r.minFilter=en,r.magFilter=Le,r.anisotropy=s.capabilities.getMaxAnisotropy(),r.generateMipmaps=!0;let a=new gn(2,1,400,400),o={position:[0,0,0],rotation:[0,0,0],vertexShader:gc,fragmentShader:xo,freqX:-5,freqY:-1.3,twist:-3,elevation:.1},l={position:[0,2.1,0],rotation:[0,0,Math.PI],vertexShader:_c,fragmentShader:xo,freqX:-3,freqY:1.9,twist:-3.5,elevation:.2};this.meshBottom=this.createMesh(o,r,a),this.meshTop=this.createMesh(l,r,a);let c=()=>{this.meshTop&&(this.meshTop.material.uniforms.uManualTime.value+=.0025),this.meshBottom&&(this.meshBottom.material.uniforms.uManualTime.value+=.0022),(this.meshTop||this.meshBottom)&&(s.render(this.scene,n),window.requestAnimationFrame(c))};c(),this.initAnim()}createMesh(t,e,n){let s=new De({vertexShader:t.vertexShader,fragmentShader:t.fragmentShader,side:Ve,depthWrite:!1,transparent:!0,uniforms:{uTexture:{value:e},uTime:{value:0},uElevation:{value:t.elevation},uTwistFactor:{value:t.twist},uTwistFactor2:{value:-2},uFrequency:{value:new Wt(t.freqX,t.freqY)},uSpeed:{value:.5},uManualTime:{value:0},uOpacity:{value:0}}}),r=new Te(n,s);return r.position.set(...t.position),r.rotation.set(...t.rotation),this.scene.add(r),r}get isMobile(){return this._isMobile}set isMobile(t){this.preloaderComplete&&this.showHideBottomMesh(t?0:1),this._isMobile=t}initAnim(){gsap.to(this.meshTop.material.uniforms.uOpacity,{value:1,duration:2,ease:"linear"}),gsap.to(this.meshBottom.material.uniforms.uOpacity,{value:1,duration:2,ease:"linear"})}onPreloaderComplete(){this.preloaderComplete=!0,this.meshTop&&(gsap.killTweensOf(this.meshTop.material.uniforms.uOpacity),gsap.to(this.meshTop.material.uniforms.uOpacity,{value:0,duration:1,ease:"linear",onComplete:()=>{this.meshTop.geometry.dispose(),this.meshTop.material.dispose(),this.scene.remove(this.meshTop),this.meshTop=null}})),this.meshBottom&&this.isMobile&&this.showHideBottomMesh(0)}showHideBottomMesh(t){gsap.killTweensOf(this.meshBottom.material.uniforms.uOpacity),gsap.to(this.meshBottom.material.uniforms.uOpacity,{value:t,duration:1,ease:"linear"})}};var vo=class{constructor(){gt(this,"isMobile");gt(this,"scrollSections");gt(this,"scrollSnap");gt(this,"mobilePinning");gt(this,"preloader");gt(this,"carousels");gt(this,"animations");gt(this,"modals");gt(this,"mql");gt(this,"nav");gt(this,"waveAnim");gt(this,"preloaderComplete",!1);this.scrollSections=document.querySelectorAll(".section"),this.scrollSnap=new $e(this.scrollSections),this.mobilePinning=new Li,this.preloader=new Ni,this.carousels=new Pi,this.animations=new Ri,this.modals=new Di,this.nav=new Ui,this.waveAnim=new ds,document.body.style.overflow="hidden",this.initBreakpointListener(),this.isMobile||gsap.set($("[data-animation]").not(".nav"),{visibility:"hidden"}),window.addEventListener("preloader_complete",this.onPreloaderComplete.bind(this)),window.addEventListener("go_to_section",this.onScrollToSection.bind(this)),window.addEventListener("modal_open",this.onModalOpen.bind(this)),window.addEventListener("modal_closed",this.onModalClosed.bind(this)),window.addEventListener("clicked_nav",this.onClickedNav.bind(this)),this.preloader.start(),this.animations.init(),this.nav.deepLink()}initBreakpointListener(){this.mql=window.matchMedia("(min-width: 992px)"),this.mql.addEventListener("change",this.onChangeBreakpoint.bind(this)),this.onChangeBreakpoint(this.mql)}onModalOpen(){this.isMobile?this.mobilePinning.kill():this.scrollSnap.paused=!0}onModalClosed(){this.isMobile?this.mobilePinning.start():this.scrollSnap.paused=!1}onClickedNav(t){let e=t.detail;if(!this.isMobile){let n=document.querySelector(`[data-section=${e}]`).querySelectorAll(".section")[0],s=[...this.scrollSections].findIndex(r=>r===n);this.scrollSnap.gotoIdx(s,!0)}}onPreloaderComplete(){this.preloaderComplete=!0,document.body.style.overflow="",this.waveAnim.onPreloaderComplete(),this.onChangeBreakpoint(this.mql)}onScrollToSection(t){let n=this.scrollSections[t.detail].closest(".section_part").dataset.section;this.nav.currentSection=n,window.history.replaceState({},"",`${document.location.origin}#${n==="none"?"top":n}`)}onChangeBreakpoint(t){this.isMobile=!t.matches,this.preloader.isMobile=this.isMobile,this.animations.isMobile=this.isMobile,this.nav.isMobile=this.isMobile,this.waveAnim.isMobile=this.isMobile,this.isMobile&&gsap.set($("[data-animation]").not(".nav"),{visibility:"visible"}),this.preloaderComplete&&(this.isMobile?(this.scrollSnap.kill(),this.mobilePinning.start()):(this.mobilePinning.kill(),this.scrollSnap.start()))}};(function(){document.readyState!=="loading"?i():document.addEventListener("DOMContentLoaded",i);function i(){new vo}})();})();
