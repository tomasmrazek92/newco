...
void main() {
  ...
  var WaveAnim = class {
    ...
    constructor() {
      ...
      renderer.setSize(sizes.width, sizes.height);
      renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));
      const texture = new TextureLoader().load("https://cdn.prod.website-files.com/67a51f5233734befd00d7699/67bf928a8f6ad5c62f6effc8_curved.png");
    ...
    initAnim() {
      ...
      gsap.to(this.meshBottom.material.uniforms.uOpacity, { value: 1, duration: 2, ease: "linear" });
    }
    onPreloaderComplete() {
      if (this.meshTop) {
